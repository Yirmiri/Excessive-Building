...
public class EBModelGen extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators generator) {
        ...
        copperBricks.donateModelTo(EBBlocks.COPPER_BRICKS, EBBlocks.WAXED_COPPER_BRICKS);
        ...
        exposedCopperBricks.donateModelTo(EBBlocks.EXPOSED_COPPER_BRICKS, EBBlocks.WAXED_EXPOSED_COPPER_BRICKS);
        ...
        weatheredCopperBricks.donateModelTo(EBBlocks.WEATHERED_COPPER_BRICKS, EBBlocks.WAXED_WEATHERED_COPPER_BRICKS);
        ...
        oxidizedCopperBricks.donateModelTo(EBBlocks.OXIDIZED_COPPER_BRICKS, EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS);
        ...
        generator.createTrivialCube(EBBlocks.IRON_GRATE);
        generator.createTrivialCube(EBBlocks.GOLD_GRATE);
        ...
        BlockModelGenerators.BlockFamilyProvider tuffTiles = generator.family(EBBlocks.TUFF_TILES);
        ...
        EBModels.registerAlmentraStatueState(generator, EBBlocks.ALMENTRA_STATUE, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "block/almentra_statue"),
                ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "block/almentra_statue_diagonal"));

        for (DyeColor colors : DyeColor.values()) {
            EBModels.registerAlmentraStatueState(generator, EBBlocks.getDyedAlmentraStatues(colors.getId()),
                    ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "block/" + colors.getName() + "_almentra_statue"),
                    ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "block/" + colors.getName() + "_almentra_statue_diagonal"));
        }
...
//                EBBlocks.GLOOM_PLANKS).includeWithoutItem(EBBlocks.GLOOM_CHEST, EBBlocks.TRAPPED_GLOOM_CHEST);
        ...
        BlockModelGenerators.BlockFamilyProvider mossyCobbledDeepslateBricks = generator.family(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider weepingBlackstoneBricks = generator.family(EBBlocks.WEEPING_BLACKSTONE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider twistingBlackstoneBricks = generator.family(EBBlocks.TWISTING_BLACKSTONE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider mossyDeepslateBricks = generator.family(EBBlocks.MOSSY_DEEPSLATE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider weepingPolishedBlackstoneBricks = generator.family(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider twistingPolishedBlackstoneBricks = generator.family(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICKS);
        ...
        BlockModelGenerators.BlockFamilyProvider oakBoard = generator.family(EBBlocks.OAK_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider spruceBoard = generator.family(EBBlocks.SPRUCE_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider birchBoard = generator.family(EBBlocks.BIRCH_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider jungleBoard = generator.family(EBBlocks.JUNGLE_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider acaciaBoard = generator.family(EBBlocks.ACACIA_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider darkOakBoard = generator.family(EBBlocks.DARK_OAK_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider mangroveBoard = generator.family(EBBlocks.MANGROVE_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider cherryBoard = generator.family(EBBlocks.CHERRY_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider crimsonBoard = generator.family(EBBlocks.CRIMSON_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider warpedBoard = generator.family(EBBlocks.WARPED_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider bambooBoard = generator.family(EBBlocks.BAMBOO_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider ancientBoard = generator.family(EBBlocks.ANCIENT_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider gloomBoard = generator.family(EBBlocks.GLOOM_BOARDS);
        ...
        BlockModelGenerators.BlockFamilyProvider armadilloScute = generator.family(EBBlocks.ARMADILLO_SCUTE_BLOCK);
        ...
        TextureMapping pumpkinTexture = TextureMapping.column(Blocks.PUMPKIN);
        generator.createPumpkinVariant(EBBlocks.WICKED_CARVED_PUMPKIN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.WICKED_JACK_O_LANTERN, pumpkinTexture);

        generator.createPumpkinVariant(EBBlocks.GRUMPY_CARVED_PUMPKIN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.GRUMPY_JACK_O_LANTERN, pumpkinTexture);

        generator.createPumpkinVariant(EBBlocks.CHEERFUL_CARVED_PUMPKIN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.CHEERFUL_JACK_O_LANTERN, pumpkinTexture);

        generator.createPumpkinVariant(EBBlocks.SOUL_JACK_O_LANTERN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.WICKED_SOUL_JACK_O_LANTERN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.GRUMPY_SOUL_JACK_O_LANTERN, pumpkinTexture);
        generator.createPumpkinVariant(EBBlocks.CHEERFUL_SOUL_JACK_O_LANTERN, pumpkinTexture);
    ...
    public void generateItemModels(ItemModelGenerators generator) {
        ...
        generator.generateFlatItem(EBItems.HAMMER, ModelTemplates.FLAT_HANDHELD_ITEM);
        generator.generateFlatItem(EBItems.WRENCH, ModelTemplates.FLAT_HANDHELD_ITEM);
    ...
    public static class EBModels {
        ...
        public static ResourceLocation getEBNamespacedBlock(String id) {
            return ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "block/" + id);
        }
        
        public static final ModelTemplate VERTICAL_STAIRS = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "template_vertical_stairs")
                .withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.PARTICLE);

        public static final ModelTemplate SEA_GLASS_PANE = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "template_sea_glass_pane")
                .withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.PARTICLE);

        public static final ModelTemplate LADDER = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "template_ladder")
                .withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.PARTICLE);

        public static final ModelTemplate MUG = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "template_mug")
                .withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.PARTICLE);

        public static final ModelTemplate PARTICLE_CANDLE = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, "template_particle_candle")
                .withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.PARTICLE);
