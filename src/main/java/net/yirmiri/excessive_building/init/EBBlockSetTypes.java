...
public class EBBlockSetTypes {
    ...
    public static class EBWoodTypes {
        public static final WoodType ANCIENT = WoodTypeBuilder.copyOf(WoodType.CHERRY).register(
                Identifier.of(ExcessiveBuilding.MOD_ID, "ancient"), EBBlockSetTypes.ANCIENT);
    }
}
