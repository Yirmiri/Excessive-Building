...
import net.yirmiri.excessive_building.common.block.configurable.*;
import net.yirmiri.excessive_building.common.block.sign.EBHangingSignBlock;
import net.yirmiri.excessive_building.common.block.sign.EBSignBlock;
import net.yirmiri.excessive_building.common.block.sign.EBWallHangingSignBlock;
import net.yirmiri.excessive_building.common.block.sign.EBWallSignBlock;
...
public class EBBlocks {
    ...
    //POLISHED ALMENTRA
    public static final Block POLISHED_ALMENTRA = register("polished_almentra", new Block(EBProperties.BlockP.POLISHED_ALMENTRA), true);
    ...
    static {
        for (DyeColor colors : DyeColor.values()) {
            ...
            DYED_POLISHED_ALMENTRA.put(colors, register(colors + "_polished_almentra", new Block(EBProperties.BlockP.POLISHED_ALMENTRA.mapColor(colors)), true));
