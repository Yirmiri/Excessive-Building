...
public class EBLangGen extends FabricLanguageProvider {
    public EBLangGen(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
        super(dataOutput);
    }
...
//        build.add(EBBlocks.TRAPPED_GLOOM_CHEST, "Trapped Gloom Chest");
        ...
        build.add("painting.excessive_building.thine_holy_peanut.author", "Cast Iron Skillet");
        ...
        build.add("item.minecraft.splash_potion.effect.endurance_potion", "Splash Potion of Endurance");
        build.add("item.minecraft.lingering_potion.effect.endurance_potion", "Lingering Potion of Endurance");
        build.add("item.minecraft.tipped_arrow.effect.endurance_potion", "Arrow of Endurance");

        build.add("item.minecraft.potion.effect.long_endurance_potion", "Potion of Endurance");
        build.add("item.minecraft.splash_potion.effect.long_endurance_potion", "Splash Potion of Endurance");
        build.add("item.minecraft.lingering_potion.effect.long_endurance_potion", "Lingering Potion of Endurance");
        build.add("item.minecraft.tipped_arrow.effect.long_endurance_potion", "Arrow of Endurance");

        build.add("item.minecraft.potion.effect.strong_endurance_potion", "Potion of Endurance");
        build.add("item.minecraft.splash_potion.effect.strong_endurance_potion", "Splash Potion of Endurance");
        build.add("item.minecraft.lingering_potion.effect.strong_endurance_potion", "Lingering Potion of Endurance");
        build.add("item.minecraft.tipped_arrow.effect.strong_endurance_potion", "Arrow of Endurance");

        build.add("item.minecraft.potion.effect.fatiguing_potion", "Potion of Fatiguing");
        build.add("item.minecraft.splash_potion.effect.fatiguing_potion", "Splash Potion of Fatiguing");
        build.add("item.minecraft.lingering_potion.effect.fatiguing_potion", "Lingering Potion of Fatiguing");
        build.add("item.minecraft.tipped_arrow.effect.fatiguing_potion", "Arrow of Fatiguing");

        build.add("item.minecraft.potion.effect.long_fatiguing_potion", "Potion of Fatiguing");
        build.add("item.minecraft.splash_potion.effect.long_fatiguing_potion", "Splash Potion of Fatiguing");
        build.add("item.minecraft.lingering_potion.effect.long_fatiguing_potion", "Lingering Potion of Fatiguing");
        build.add("item.minecraft.tipped_arrow.effect.long_fatiguing_potion", "Arrow of Fatiguing");

        build.add("item.minecraft.potion.effect.strong_fatiguing_potion", "Potion of Fatiguing");
        build.add("item.minecraft.splash_potion.effect.strong_fatiguing_potion", "Splash Potion of Fatiguing");
        build.add("item.minecraft.lingering_potion.effect.strong_fatiguing_potion", "Lingering Potion of Fatiguing");
        build.add("item.minecraft.tipped_arrow.effect.strong_fatiguing_potion", "Arrow of Fatiguing");
    }
}
