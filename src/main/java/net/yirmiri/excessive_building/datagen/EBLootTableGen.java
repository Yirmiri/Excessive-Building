...
public class EBLootTableGen extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB, slabDrops(EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB));
        ...
        addDrop(EBBlocks.GRANITE_BRICK_SLAB, EBBlocks.GRANITE_BRICK_SLAB);
        ...
        addDrop(EBBlocks.ANDESITE_BRICK_SLAB, EBBlocks.ANDESITE_BRICK_SLAB);
        ...
        addDrop(EBBlocks.DIORITE_BRICK_SLAB, EBBlocks.DIORITE_BRICK_SLAB);
        ...
        addDrop(EBBlocks.SMOOTH_BRICK_SLAB, EBBlocks.SMOOTH_BRICK_SLAB);
        ...
        addDrop(EBBlocks.BRIMSTONE_SLAB, EBBlocks.BRIMSTONE_SLAB);
        ...
        addDrop(EBBlocks.POLISHED_STONE_SLAB, EBBlocks.POLISHED_STONE_SLAB);
        ...
        addDrop(EBBlocks.SMOOTH_STONE_BRICK_SLAB, EBBlocks.SMOOTH_STONE_BRICK_SLAB);
        ...
        addDrop(EBBlocks.SMOOTH_STONE_TILE_SLAB, EBBlocks.SMOOTH_STONE_TILE_SLAB);
        ...
        addDrop(EBBlocks.REDSTONE_BRICK_SLAB, EBBlocks.REDSTONE_BRICK_SLAB);
...
//        addDrop(EBBlocks.TRAPPED_GLOOM_CHEST);
        ...
        addDrop(EBBlocks.THIN_DIVIDED_PAPER_BLOCK);
        addDrop(EBBlocks.THIN_PAPER_STAIRS);
        addDrop(EBBlocks.THIN_PAPER_VERTICAL_STAIRS);
        addDrop(EBBlocks.THIN_PAPER_SLAB, EBBlocks.THIN_PAPER_SLAB);
        addDrop(EBBlocks.THICK_PAPER_BLOCK);
        addDrop(EBBlocks.THICK_DIAGONAL_PAPER_BLOCK);
        addDrop(EBBlocks.THICK_DIVIDED_PAPER_BLOCK);
        ...
        addDrop(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICKS);
        addDrop(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICK_STAIRS);
        addDrop(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICK_SLAB, slabDrops(EBBlocks.MOSSY_COBBLED_DEEPSLATE_BRICK_SLAB));
        addDrop(EBBlocks.WEEPING_BLACKSTONE_BRICKS);
        addDrop(EBBlocks.WEEPING_BLACKSTONE_BRICK_STAIRS);
        addDrop(EBBlocks.WEEPING_BLACKSTONE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.WEEPING_BLACKSTONE_BRICK_SLAB, slabDrops(EBBlocks.WEEPING_BLACKSTONE_BRICK_SLAB));
        addDrop(EBBlocks.TWISTING_BLACKSTONE_BRICKS);
        addDrop(EBBlocks.TWISTING_BLACKSTONE_BRICK_STAIRS);
        addDrop(EBBlocks.TWISTING_BLACKSTONE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.TWISTING_BLACKSTONE_BRICK_SLAB, slabDrops(EBBlocks.TWISTING_BLACKSTONE_BRICK_SLAB));
        addDrop(EBBlocks.MOSSY_DEEPSLATE_BRICKS);
        addDrop(EBBlocks.MOSSY_DEEPSLATE_BRICK_STAIRS);
        addDrop(EBBlocks.MOSSY_DEEPSLATE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.MOSSY_DEEPSLATE_BRICK_SLAB, slabDrops(EBBlocks.MOSSY_DEEPSLATE_BRICK_SLAB));
        addDrop(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICKS);
        addDrop(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_STAIRS);
        addDrop(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_SLAB, slabDrops(EBBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_SLAB));
        addDrop(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICKS);
        addDrop(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICK_STAIRS);
        addDrop(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS);
        addDrop(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICK_SLAB, slabDrops(EBBlocks.TWISTING_POLISHED_BLACKSTONE_BRICK_SLAB));
        addDrop(EBBlocks.ARMADILLO_SCUTE_BLOCK);
        addDrop(EBBlocks.OAK_BOARDS);
        addDrop(EBBlocks.OAK_BOARD_STAIRS);
        addDrop(EBBlocks.OAK_BOARD_SLAB, slabDrops(EBBlocks.OAK_BOARD_SLAB));
        addDrop(EBBlocks.OAK_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.SPRUCE_BOARDS);
        addDrop(EBBlocks.SPRUCE_BOARD_STAIRS);
        addDrop(EBBlocks.SPRUCE_BOARD_SLAB, slabDrops(EBBlocks.SPRUCE_BOARD_SLAB));
        addDrop(EBBlocks.SPRUCE_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.BIRCH_BOARDS);
        addDrop(EBBlocks.BIRCH_BOARD_STAIRS);
        addDrop(EBBlocks.BIRCH_BOARD_SLAB, slabDrops(EBBlocks.BIRCH_BOARD_SLAB));
        addDrop(EBBlocks.BIRCH_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.JUNGLE_BOARDS);
        addDrop(EBBlocks.JUNGLE_BOARD_STAIRS);
        addDrop(EBBlocks.JUNGLE_BOARD_SLAB, slabDrops(EBBlocks.JUNGLE_BOARD_SLAB));
        addDrop(EBBlocks.JUNGLE_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.ACACIA_BOARDS);
        addDrop(EBBlocks.ACACIA_BOARD_STAIRS);
        addDrop(EBBlocks.ACACIA_BOARD_SLAB, slabDrops(EBBlocks.ACACIA_BOARD_SLAB));
        addDrop(EBBlocks.ACACIA_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.DARK_OAK_BOARDS);
        addDrop(EBBlocks.DARK_OAK_BOARD_STAIRS);
        addDrop(EBBlocks.DARK_OAK_BOARD_SLAB, slabDrops(EBBlocks.DARK_OAK_BOARD_SLAB));
        addDrop(EBBlocks.DARK_OAK_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.MANGROVE_BOARDS);
        addDrop(EBBlocks.MANGROVE_BOARD_STAIRS);
        addDrop(EBBlocks.MANGROVE_BOARD_SLAB, slabDrops(EBBlocks.MANGROVE_BOARD_SLAB));
        addDrop(EBBlocks.MANGROVE_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.CHERRY_BOARDS);
        addDrop(EBBlocks.CHERRY_BOARD_STAIRS);
        addDrop(EBBlocks.CHERRY_BOARD_SLAB, slabDrops(EBBlocks.CHERRY_BOARD_SLAB));
        addDrop(EBBlocks.CHERRY_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.CRIMSON_BOARDS);
        addDrop(EBBlocks.CRIMSON_BOARD_STAIRS);
        addDrop(EBBlocks.CRIMSON_BOARD_SLAB, slabDrops(EBBlocks.CRIMSON_BOARD_SLAB));
        addDrop(EBBlocks.CRIMSON_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.WARPED_BOARDS);
        addDrop(EBBlocks.WARPED_BOARD_STAIRS);
        addDrop(EBBlocks.WARPED_BOARD_SLAB, slabDrops(EBBlocks.WARPED_BOARD_SLAB));
        addDrop(EBBlocks.WARPED_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.BAMBOO_BOARDS);
        addDrop(EBBlocks.BAMBOO_BOARD_STAIRS);
        addDrop(EBBlocks.BAMBOO_BOARD_SLAB, slabDrops(EBBlocks.BAMBOO_BOARD_SLAB));
        addDrop(EBBlocks.BAMBOO_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.ANCIENT_BOARDS);
        addDrop(EBBlocks.ANCIENT_BOARD_STAIRS);
        addDrop(EBBlocks.ANCIENT_BOARD_SLAB, slabDrops(EBBlocks.ANCIENT_BOARD_SLAB));
        addDrop(EBBlocks.ANCIENT_BOARD_VERTICAL_STAIRS);
        addDrop(EBBlocks.GLOOM_BOARDS);
