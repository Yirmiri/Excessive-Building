...
public class EBRecipeGen extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        createTwoByTwoRecipe(EBBlocks.CHISELED_OAK_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_OAK_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_SPRUCE_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_SPRUCE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_BIRCH_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_BIRCH_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_JUNGLE_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_JUNGLE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_ACACIA_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_ACACIA_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_DARK_OAK_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_DARK_OAK_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_MANGROVE_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_MANGROVE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_CHERRY_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_CHERRY_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_BAMBOO_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_BAMBOO_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_CRIMSON_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_CRIMSON_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_WARPED_PLANKS, 2,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_WARPED_PLANKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OAK_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.OAK_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OAK_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.OAK_MOSAIC))
                .criterion(hasItem(EBBlocks.OAK_MOSAIC), conditionsFromItem(EBBlocks.OAK_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.OAK_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.OAK_MOSAIC))
                .criterion(hasItem(EBBlocks.OAK_MOSAIC), conditionsFromItem(EBBlocks.OAK_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_MOSAIC_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BAMBOO_MOSAIC_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BAMBOO_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SPRUCE_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.SPRUCE_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SPRUCE_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.SPRUCE_MOSAIC))
                .criterion(hasItem(EBBlocks.SPRUCE_MOSAIC), conditionsFromItem(EBBlocks.SPRUCE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SPRUCE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SPRUCE_MOSAIC))
                .criterion(hasItem(EBBlocks.SPRUCE_MOSAIC), conditionsFromItem(EBBlocks.SPRUCE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BIRCH_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.BIRCH_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BIRCH_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.BIRCH_MOSAIC))
                .criterion(hasItem(EBBlocks.BIRCH_MOSAIC), conditionsFromItem(EBBlocks.BIRCH_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BIRCH_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.BIRCH_MOSAIC))
                .criterion(hasItem(EBBlocks.BIRCH_MOSAIC), conditionsFromItem(EBBlocks.BIRCH_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.JUNGLE_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.JUNGLE_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.JUNGLE_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.JUNGLE_MOSAIC))
                .criterion(hasItem(EBBlocks.JUNGLE_MOSAIC), conditionsFromItem(EBBlocks.JUNGLE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.JUNGLE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.JUNGLE_MOSAIC))
                .criterion(hasItem(EBBlocks.JUNGLE_MOSAIC), conditionsFromItem(EBBlocks.JUNGLE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ACACIA_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.ACACIA_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ACACIA_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.ACACIA_MOSAIC))
                .criterion(hasItem(EBBlocks.ACACIA_MOSAIC), conditionsFromItem(EBBlocks.ACACIA_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ACACIA_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ACACIA_MOSAIC))
                .criterion(hasItem(EBBlocks.ACACIA_MOSAIC), conditionsFromItem(EBBlocks.ACACIA_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DARK_OAK_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.DARK_OAK_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DARK_OAK_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.DARK_OAK_MOSAIC))
                .criterion(hasItem(EBBlocks.DARK_OAK_MOSAIC), conditionsFromItem(EBBlocks.DARK_OAK_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DARK_OAK_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.DARK_OAK_MOSAIC))
                .criterion(hasItem(EBBlocks.DARK_OAK_MOSAIC), conditionsFromItem(EBBlocks.DARK_OAK_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MANGROVE_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.MANGROVE_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MANGROVE_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.MANGROVE_MOSAIC))
                .criterion(hasItem(EBBlocks.MANGROVE_MOSAIC), conditionsFromItem(EBBlocks.MANGROVE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.MANGROVE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.MANGROVE_MOSAIC))
                .criterion(hasItem(EBBlocks.MANGROVE_MOSAIC), conditionsFromItem(EBBlocks.MANGROVE_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHERRY_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.CHERRY_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHERRY_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.CHERRY_MOSAIC))
                .criterion(hasItem(EBBlocks.CHERRY_MOSAIC), conditionsFromItem(EBBlocks.CHERRY_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.CHERRY_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.CHERRY_MOSAIC))
                .criterion(hasItem(EBBlocks.CHERRY_MOSAIC), conditionsFromItem(EBBlocks.CHERRY_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRIMSON_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.CRIMSON_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRIMSON_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.CRIMSON_MOSAIC))
                .criterion(hasItem(EBBlocks.CRIMSON_MOSAIC), conditionsFromItem(EBBlocks.CRIMSON_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.CRIMSON_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.CRIMSON_MOSAIC))
                .criterion(hasItem(EBBlocks.CRIMSON_MOSAIC), conditionsFromItem(EBBlocks.CRIMSON_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WARPED_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.WARPED_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WARPED_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.WARPED_MOSAIC))
                .criterion(hasItem(EBBlocks.WARPED_MOSAIC), conditionsFromItem(EBBlocks.WARPED_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WARPED_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WARPED_MOSAIC))
                .criterion(hasItem(EBBlocks.WARPED_MOSAIC), conditionsFromItem(EBBlocks.WARPED_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_MOSAIC_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.COBBLESTONE_BRICKS,
                Ingredient.ofItems(Blocks.COBBLESTONE))
                .criterion(hasItem(Blocks.COBBLESTONE), conditionsFromItem(Blocks.COBBLESTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLESTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.COBBLESTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLESTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLESTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.COBBLESTONE_BRICKS))
                .criterion(hasItem(EBBlocks.COBBLESTONE_BRICKS), conditionsFromItem(EBBlocks.COBBLESTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLESTONE_BRICK_SLAB)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.MOSSY_COBBLESTONE_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.MOSSY_COBBLESTONE_BRICKS))
                .criterion(hasItem(EBBlocks.MOSSY_COBBLESTONE_BRICKS), conditionsFromItem(EBBlocks.MOSSY_COBBLESTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB)));
        ...
        createStairsRecipe(EBBlocks.COBBLED_DEEPSLATE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLED_DEEPSLATE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLED_DEEPSLATE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.COBBLED_DEEPSLATE_BRICKS))
                .criterion(hasItem(EBBlocks.COBBLED_DEEPSLATE_BRICKS), conditionsFromItem(EBBlocks.COBBLED_DEEPSLATE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLED_DEEPSLATE_BRICK_SLAB)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.BLACKSTONE_BRICKS, 4,
                Ingredient.ofItems(Blocks.BLACKSTONE), Ingredient.ofItems(Blocks.POLISHED_BLACKSTONE))
                .criterion(hasItem(Blocks.BLACKSTONE), conditionsFromItem(Blocks.BLACKSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BLACKSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.BLACKSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BLACKSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BLACKSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.BLACKSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.BLACKSTONE_BRICKS), conditionsFromItem(EBBlocks.BLACKSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BLACKSTONE_BRICK_SLAB)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_MOSAIC, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_MOSAIC)));
        ...
        createStairsRecipe(EBBlocks.ANCIENT_MOSAIC_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_MOSAIC_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_MOSAIC_SLAB,
                Ingredient.ofItems(EBBlocks.ANCIENT_MOSAIC))
                .criterion(hasItem(EBBlocks.ANCIENT_MOSAIC), conditionsFromItem(EBBlocks.ANCIENT_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANCIENT_MOSAIC_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ANCIENT_MOSAIC))
                .criterion(hasItem(EBBlocks.ANCIENT_MOSAIC), conditionsFromItem(EBBlocks.ANCIENT_MOSAIC))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_PLANKS, 4)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_PLANKS)));
        ...
        createStairsRecipe(EBBlocks.ANCIENT_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_SLAB,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANCIENT_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_VERTICAL_STAIRS)));

        createFenceRecipe(EBBlocks.ANCIENT_FENCE,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_FENCE)));

        createFenceGateRecipe(EBBlocks.ANCIENT_FENCE_GATE,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_FENCE_GATE)));

        createDoorRecipe(EBBlocks.ANCIENT_DOOR,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_DOOR)));

        createTrapdoorRecipe(EBBlocks.ANCIENT_TRAPDOOR,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_TRAPDOOR)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.REDSTONE, EBBlocks.ANCIENT_PRESSURE_PLATE, 1)
                .input('#', EBBlocks.ANCIENT_PLANKS)
                .pattern("##")
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_PRESSURE_PLATE)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE, EBBlocks.ANCIENT_BUTTON, 1)
                .input(EBBlocks.ANCIENT_PLANKS)
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANCIENT_BUTTON)));

        createSignRecipe(EBItems.ANCIENT_SIGN,
                Ingredient.ofItems(EBBlocks.ANCIENT_PLANKS))
                .criterion(hasItem(EBBlocks.ANCIENT_PLANKS), conditionsFromItem(EBBlocks.ANCIENT_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBItems.ANCIENT_SIGN)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COPPER_BRICK_STAIRS)));
        ...
        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COPPER_BRICK_SLAB,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.COPPER_BRICKS), conditionsFromItem(EBBlocks.COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.EXPOSED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EXPOSED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.EXPOSED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.EXPOSED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.EXPOSED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.EXPOSED_COPPER_BRICKS), conditionsFromItem(EBBlocks.EXPOSED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.EXPOSED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.EXPOSED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.EXPOSED_COPPER_BRICKS), conditionsFromItem(EBBlocks.EXPOSED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.WEATHERED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEATHERED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.WEATHERED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WEATHERED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.WEATHERED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WEATHERED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WEATHERED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WEATHERED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WEATHERED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WEATHERED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WEATHERED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.OXIDIZED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OXIDIZED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.OXIDIZED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OXIDIZED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.OXIDIZED_COPPER_BRICKS), conditionsFromItem(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.OXIDIZED_COPPER_BRICKS), conditionsFromItem(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.WAXED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.WAXED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.WAXED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WAXED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .criterion(hasItem(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS), conditionsFromItem(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS)));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICKS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICKS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICKS), conditionsFromItem(EBBlocks.COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICKS) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_SLAB, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICKS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICKS), conditionsFromItem(EBBlocks.COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_SLAB), conditionsFromItem(EBBlocks.COPPER_BRICK_SLAB))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICKS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICKS), conditionsFromItem(EBBlocks.COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_SLAB), conditionsFromItem(EBBlocks.COPPER_BRICK_SLAB))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICKS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICKS), conditionsFromItem(EBBlocks.COPPER_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_SLAB), conditionsFromItem(EBBlocks.COPPER_BRICK_SLAB))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.ofItems(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .criterion(hasItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), conditionsFromItem(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));

        createTwoByTwoRecipe(EBBlocks.IRON_BRICKS, 1,
                Ingredient.ofItems(Items.IRON_INGOT))
                .criterion(hasItem(Items.IRON_INGOT), conditionsFromItem(Items.IRON_INGOT))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.IRON_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.IRON_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.IRON_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.IRON_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.IRON_BRICKS))
                .criterion(hasItem(EBBlocks.IRON_BRICKS), conditionsFromItem(EBBlocks.IRON_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.IRON_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.IRON_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.IRON_BRICKS))
                .criterion(hasItem(EBBlocks.IRON_BRICKS), conditionsFromItem(EBBlocks.IRON_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.IRON_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.EMERALD_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EMERALD_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.EMERALD_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EMERALD_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.EMERALD_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.EMERALD_BRICKS))
                .criterion(hasItem(EBBlocks.EMERALD_BRICKS), conditionsFromItem(EBBlocks.EMERALD_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EMERALD_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.EMERALD_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.EMERALD_BRICKS))
                .criterion(hasItem(EBBlocks.EMERALD_BRICKS), conditionsFromItem(EBBlocks.EMERALD_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EMERALD_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.GOLD_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GOLD_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.GOLD_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GOLD_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GOLD_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.GOLD_BRICKS))
                .criterion(hasItem(EBBlocks.GOLD_BRICKS), conditionsFromItem(EBBlocks.GOLD_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GOLD_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GOLD_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.GOLD_BRICKS))
                .criterion(hasItem(EBBlocks.GOLD_BRICKS), conditionsFromItem(EBBlocks.GOLD_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GOLD_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.LAPIS_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.LAPIS_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.LAPIS_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.LAPIS_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.LAPIS_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.LAPIS_BRICKS))
                .criterion(hasItem(EBBlocks.LAPIS_BRICKS), conditionsFromItem(EBBlocks.LAPIS_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.LAPIS_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.LAPIS_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.LAPIS_BRICKS))
                .criterion(hasItem(EBBlocks.LAPIS_BRICKS), conditionsFromItem(EBBlocks.LAPIS_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.LAPIS_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.DIAMOND_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIAMOND_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.DIAMOND_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIAMOND_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DIAMOND_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.DIAMOND_BRICKS))
                .criterion(hasItem(EBBlocks.DIAMOND_BRICKS), conditionsFromItem(EBBlocks.DIAMOND_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIAMOND_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DIAMOND_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.DIAMOND_BRICKS))
                .criterion(hasItem(EBBlocks.DIAMOND_BRICKS), conditionsFromItem(EBBlocks.DIAMOND_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIAMOND_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.NETHERITE_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.NETHERITE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.NETHERITE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.NETHERITE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.NETHERITE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.NETHERITE_BRICKS))
                .criterion(hasItem(EBBlocks.NETHERITE_BRICKS), conditionsFromItem(EBBlocks.NETHERITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.NETHERITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.NETHERITE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.NETHERITE_BRICKS))
                .criterion(hasItem(EBBlocks.NETHERITE_BRICKS), conditionsFromItem(EBBlocks.NETHERITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.NETHERITE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SEA_GLASS, 4)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SEA_GLASS)));
        ...
        createDyeEightRecipe(EBBlocks.SCARLET_SEA_GLASS, 8,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SCARLET_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.VERDANT_SEA_GLASS, 8,
                Ingredient.ofItems(EBBlocks.SEA_GLASS), Ingredient.ofItems(Items.LIME_DYE))
                .criterion(hasItem(EBBlocks.SEA_GLASS), conditionsFromItem(EBBlocks.SEA_GLASS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.VERDANT_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.ROSE_SEA_GLASS, 8,
                Ingredient.ofItems(EBBlocks.SEA_GLASS), Ingredient.ofItems(Items.PINK_DYE))
                .criterion(hasItem(EBBlocks.SEA_GLASS), conditionsFromItem(EBBlocks.SEA_GLASS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ROSE_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.AQUA_SEA_GLASS, 8,
                Ingredient.ofItems(EBBlocks.SEA_GLASS), Ingredient.ofItems(Items.BLUE_DYE))
                .criterion(hasItem(EBBlocks.SEA_GLASS), conditionsFromItem(EBBlocks.SEA_GLASS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.AQUA_SEA_GLASS)));
        ...
        createDyeEightRecipe(EBBlocks.FUCHSIA_SEA_GLASS, 8,
                ...
                .criterion(hasItem(EBBlocks.SEA_GLASS), conditionsFromItem(EBBlocks.SEA_GLASS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.FUCHSIA_SEA_GLASS)));

        createPaneRecipe(EBBlocks.SEA_GLASS_PANE, 16,
                Ingredient.ofItems(EBBlocks.SEA_GLASS))
                .criterion(hasItem(EBBlocks.SEA_GLASS), conditionsFromItem(EBBlocks.SEA_GLASS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.SCARLET_SEA_GLASS_PANE, 16,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SCARLET_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.FUCHSIA_SEA_GLASS_PANE, 16,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.FUCHSIA_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.AQUA_SEA_GLASS_PANE, 16,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.AQUA_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.VERDANT_SEA_GLASS_PANE, 16,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.VERDANT_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.ROSE_SEA_GLASS_PANE, 16,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ROSE_SEA_GLASS_PANE)));
        ...
        createDyeEightRecipe(EBBlocks.SCARLET_SEA_GLASS_PANE, 8,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SCARLET_SEA_GLASS_PANE) + "_from_dye"));
        ...
        createDyeEightRecipe(EBBlocks.VERDANT_SEA_GLASS_PANE, 8,
                ...
                .criterion(hasItem(EBBlocks.SEA_GLASS_PANE), conditionsFromItem(EBBlocks.SEA_GLASS_PANE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.VERDANT_SEA_GLASS_PANE) + "_from_dye"));
        ...
        createDyeEightRecipe(EBBlocks.ROSE_SEA_GLASS_PANE, 8,
                ...
                .criterion(hasItem(EBBlocks.SEA_GLASS_PANE), conditionsFromItem(EBBlocks.SEA_GLASS_PANE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ROSE_SEA_GLASS_PANE) + "_from_dye"));
        ...
        createDyeEightRecipe(EBBlocks.AQUA_SEA_GLASS_PANE, 8,
                ...
                .criterion(hasItem(EBBlocks.SEA_GLASS_PANE), conditionsFromItem(EBBlocks.SEA_GLASS_PANE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.AQUA_SEA_GLASS_PANE) + "_from_dye"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_MAGMA_BLOCK, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_MAGMA_BLOCK)));
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE)));
        ...
        createStairsRecipe(EBBlocks.SOUL_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.SOUL_SANDSTONE_WALL, 6,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_WALL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SOUL_SANDSTONE, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_SOUL_SANDSTONE)));

        createTwoByTwoRecipe(EBBlocks.CUT_SOUL_SANDSTONE, 4,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CUT_SOUL_SANDSTONE)));
        ...
        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CUT_SOUL_SANDSTONE_SLAB,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CUT_SOUL_SANDSTONE_SLAB)));
        ...
        createStairsRecipe(EBBlocks.SMOOTH_SOUL_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_SOUL_SANDSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SMOOTH_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SMOOTH_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_SANDSTONE, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SANDSTONE)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SANDSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_SANDSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SANDSTONE_BRICKS, 4,
                Ingredient.ofItems(EBBlocks.POLISHED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.SANDSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SANDSTONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ENGRAVED_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DECORATED_SANDSTONE_BRICKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SANDSTONE_TILES, 4,
                Ingredient.ofItems(EBBlocks.SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_TILES)));
        ...
        createStairsRecipe(EBBlocks.SANDSTONE_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.SANDSTONE_TILES), conditionsFromItem(EBBlocks.SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.SANDSTONE_TILES), conditionsFromItem(EBBlocks.SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_RED_SANDSTONE, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_RED_SANDSTONE)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_RED_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_RED_SANDSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_RED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_RED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_RED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_RED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_RED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_RED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_RED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.RED_SANDSTONE_BRICKS, 4,
                Ingredient.ofItems(EBBlocks.POLISHED_RED_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_RED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_RED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.RED_SANDSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.RED_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.RED_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.RED_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.RED_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.RED_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.RED_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_RED_SANDSTONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_RED_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_RED_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DECORATED_RED_SANDSTONE_BRICKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.RED_SANDSTONE_TILES, 4,
                Ingredient.ofItems(EBBlocks.RED_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.RED_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.RED_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_TILES)));
        ...
        createStairsRecipe(EBBlocks.RED_SANDSTONE_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.RED_SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.RED_SANDSTONE_TILES), conditionsFromItem(EBBlocks.RED_SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.RED_SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.RED_SANDSTONE_TILES), conditionsFromItem(EBBlocks.RED_SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_SOUL_SANDSTONE, 4,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE), conditionsFromItem(EBBlocks.SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_SOUL_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_SOUL_SANDSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE_BRICKS, 4,
                Ingredient.ofItems(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.SOUL_SANDSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SOUL_SANDSTONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_SOUL_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_SOUL_SANDSTONE_BRICKS, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DECORATED_SOUL_SANDSTONE_BRICKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE_TILES, 4,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE_BRICKS), conditionsFromItem(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_TILES)));
        ...
        createStairsRecipe(EBBlocks.SOUL_SANDSTONE_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE_TILES), conditionsFromItem(EBBlocks.SOUL_SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SOUL_SANDSTONE_TILES))
                .criterion(hasItem(EBBlocks.SOUL_SANDSTONE_TILES), conditionsFromItem(EBBlocks.SOUL_SANDSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createLadderRecipe(EBBlocks.SPRUCE_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.BIRCH_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_LADDER)));
        ...
        createLadderRecipe(EBBlocks.JUNGLE_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.ACACIA_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_LADDER)));
        ...
        createLadderRecipe(EBBlocks.DARK_OAK_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_LADDER)));
        ...
        createLadderRecipe(EBBlocks.MANGROVE_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.CHERRY_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_LADDER)));
        ...
        createLadderRecipe(EBBlocks.BAMBOO_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BAMBOO_LADDER)));
        ...
        createLadderRecipe(EBBlocks.CRIMSON_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_LADDER)));
        ...
        createLadderRecipe(EBBlocks.WARPED_LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_LADDER)));
        ...
        createLadderRecipe(Blocks.LADDER,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(Blocks.LADDER)));

        createTwoByTwoRecipe(EBBlocks.SPRUCE_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.SPRUCE_PLANKS))
                .criterion(hasItem(Blocks.SPRUCE_PLANKS), conditionsFromItem(Blocks.SPRUCE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.WARPED_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.WARPED_PLANKS))
                .criterion(hasItem(Blocks.WARPED_PLANKS), conditionsFromItem(Blocks.WARPED_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.CRIMSON_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.CRIMSON_PLANKS))
                .criterion(hasItem(Blocks.CRIMSON_PLANKS), conditionsFromItem(Blocks.CRIMSON_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.BAMBOO_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.BAMBOO_PLANKS))
                .criterion(hasItem(Blocks.BAMBOO_PLANKS), conditionsFromItem(Blocks.BAMBOO_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BAMBOO_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.CHERRY_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.CHERRY_PLANKS))
                .criterion(hasItem(Blocks.CHERRY_PLANKS), conditionsFromItem(Blocks.CHERRY_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.MANGROVE_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.MANGROVE_PLANKS))
                .criterion(hasItem(Blocks.MANGROVE_PLANKS), conditionsFromItem(Blocks.MANGROVE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.DARK_OAK_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.DARK_OAK_PLANKS))
                .criterion(hasItem(Blocks.DARK_OAK_PLANKS), conditionsFromItem(Blocks.DARK_OAK_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.ACACIA_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.ACACIA_PLANKS))
                .criterion(hasItem(Blocks.ACACIA_PLANKS), conditionsFromItem(Blocks.ACACIA_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.JUNGLE_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.JUNGLE_PLANKS))
                .criterion(hasItem(Blocks.JUNGLE_PLANKS), conditionsFromItem(Blocks.JUNGLE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.BIRCH_CRAFTING_TABLE, 1,
                Ingredient.ofItems(Blocks.BIRCH_PLANKS))
                .criterion(hasItem(Blocks.BIRCH_PLANKS), conditionsFromItem(Blocks.BIRCH_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_CRAFTING_TABLE)));
        ...
        createStairsRecipe(EBBlocks.QUARTZ_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.QUARTZ_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.QUARTZ_BRICK_SLAB,
                Ingredient.ofItems(Blocks.QUARTZ_BRICKS))
                .criterion(hasItem(Blocks.QUARTZ_BRICKS), conditionsFromItem(Blocks.QUARTZ_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.QUARTZ_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.QUARTZ_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.QUARTZ_BRICKS))
                .criterion(hasItem(Blocks.QUARTZ_BRICKS), conditionsFromItem(Blocks.QUARTZ_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.QUARTZ_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.QUARTZ_BRICK_WALL, 6,
                Ingredient.ofItems(Blocks.QUARTZ_BRICKS))
                .criterion(hasItem(Blocks.QUARTZ_BRICKS), conditionsFromItem(Blocks.QUARTZ_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.QUARTZ_BRICK_WALL)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createStairsRecipe(EBBlocks.getDyedTerracottaTileStairs(colors.getId()),
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTileStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedTerracottaTileSlab(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedTerracottaTiles(colors.getId())), conditionsFromItem(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTileSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedTerracottaTileVerticalStairs(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedTerracottaTiles(colors.getId())), conditionsFromItem(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTileVerticalStairs(colors.getId()))));
        }
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.TERRACOTTA_TILES, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TERRACOTTA_TILES)));
        ...
        createStairsRecipe(EBBlocks.TERRACOTTA_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TERRACOTTA_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.TERRACOTTA_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.TERRACOTTA_TILES))
                .criterion(hasItem(EBBlocks.TERRACOTTA_TILES), conditionsFromItem(EBBlocks.TERRACOTTA_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TERRACOTTA_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.TERRACOTTA_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.TERRACOTTA_TILES))
                .criterion(hasItem(EBBlocks.TERRACOTTA_TILES), conditionsFromItem(EBBlocks.TERRACOTTA_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TERRACOTTA_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.WHITE.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.WHITE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_GRAY.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_GRAY.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.GRAY.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.GRAY.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BLACK.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BLACK.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BROWN.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BROWN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.RED.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.RED.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.ORANGE.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.ORANGE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.YELLOW.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.YELLOW.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIME.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIME.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.GREEN.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.GREEN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.CYAN.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.CYAN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_BLUE.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_BLUE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BLUE.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BLUE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.PURPLE.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.PURPLE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.MAGENTA.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.MAGENTA.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.PINK.getId()), 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.PINK.getId()))));

        createVerticalStairsRecipe(EBBlocks.OAK_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.OAK_PLANKS))
                .criterion(hasItem(Blocks.OAK_PLANKS), conditionsFromItem(Blocks.OAK_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_VERTICAL_STAIRS)));

        createVerticalStairsRecipe(EBBlocks.SPRUCE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.SPRUCE_PLANKS))
                .criterion(hasItem(Blocks.SPRUCE_PLANKS), conditionsFromItem(Blocks.SPRUCE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_VERTICAL_STAIRS)));

        createVerticalStairsRecipe(EBBlocks.BIRCH_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.BIRCH_PLANKS))
                .criterion(hasItem(Blocks.BIRCH_PLANKS), conditionsFromItem(Blocks.BIRCH_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.JUNGLE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.JUNGLE_PLANKS))
                .criterion(hasItem(Blocks.JUNGLE_PLANKS), conditionsFromItem(Blocks.JUNGLE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.ACACIA_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.ACACIA_PLANKS))
                .criterion(hasItem(Blocks.ACACIA_PLANKS), conditionsFromItem(Blocks.ACACIA_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.DARK_OAK_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.DARK_OAK_PLANKS))
                .criterion(hasItem(Blocks.DARK_OAK_PLANKS), conditionsFromItem(Blocks.DARK_OAK_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.MANGROVE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.MANGROVE_PLANKS))
                .criterion(hasItem(Blocks.MANGROVE_PLANKS), conditionsFromItem(Blocks.MANGROVE_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.CHERRY_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.CHERRY_PLANKS))
                .criterion(hasItem(Blocks.CHERRY_PLANKS), conditionsFromItem(Blocks.CHERRY_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.BAMBOO_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.BAMBOO_PLANKS))
                .criterion(hasItem(Blocks.BAMBOO_PLANKS), conditionsFromItem(Blocks.BAMBOO_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BAMBOO_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.CRIMSON_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.CRIMSON_PLANKS))
                .criterion(hasItem(Blocks.CRIMSON_PLANKS), conditionsFromItem(Blocks.CRIMSON_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.WARPED_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.WARPED_PLANKS))
                .criterion(hasItem(Blocks.WARPED_PLANKS), conditionsFromItem(Blocks.WARPED_PLANKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.STONE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.STONE))
                .criterion(hasItem(Blocks.STONE), conditionsFromItem(Blocks.STONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.STONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.COBBLESTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.COBBLESTONE))
                .criterion(hasItem(Blocks.COBBLESTONE), conditionsFromItem(Blocks.COBBLESTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLESTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.MOSSY_COBBLESTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.MOSSY_COBBLESTONE))
                .criterion(hasItem(Blocks.MOSSY_COBBLESTONE), conditionsFromItem(Blocks.MOSSY_COBBLESTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MOSSY_COBBLESTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.STONE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.MOSSY_STONE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MOSSY_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.COBBLED_DEEPSLATE_VERTICAL_STAIRS,
                ...
                .criterion(hasItem(Blocks.COBBLED_DEEPSLATE), conditionsFromItem(Blocks.COBBLED_DEEPSLATE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.COBBLED_DEEPSLATE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DEEPSLATE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DEEPSLATE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DEEPSLATE_TILE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DEEPSLATE_TILE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_DEEPSLATE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_DEEPSLATE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.QUARTZ_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.QUARTZ_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_QUARTZ_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_QUARTZ_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.SANDSTONE))
                .criterion(hasItem(Blocks.SANDSTONE), conditionsFromItem(Blocks.SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(Blocks.RED_SANDSTONE))
                .criterion(hasItem(Blocks.RED_SANDSTONE), conditionsFromItem(Blocks.RED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_SANDSTONE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_RED_SANDSTONE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BLACKSTONE_VERTICAL_STAIRS,
                ...
                .criterion(hasItem(Blocks.BLACKSTONE), conditionsFromItem(Blocks.BLACKSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BLACKSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_BLACKSTONE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BLACKSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.NETHER_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.NETHER_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.RED_NETHER_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_NETHER_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PRISMARINE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.PRISMARINE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PRISMARINE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.PRISMARINE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DARK_PRISMARINE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_PRISMARINE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.ANDESITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_ANDESITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_ANDESITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.GRANITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_GRANITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_GRANITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DIORITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_DIORITE_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_DIORITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.END_STONE_BRICK_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.END_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PURPUR_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.PURPUR_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.EXPOSED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.EXPOSED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WEATHERED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEATHERED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.OXIDIZED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OXIDIZED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_EXPOSED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_EXPOSED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_WEATHERED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_WEATHERED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_OXIDIZED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WAXED_OXIDIZED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.GRANITE_BRICKS, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.GRANITE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GRANITE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.GRANITE_BRICKS))
                .criterion(hasItem(EBBlocks.GRANITE_BRICKS), conditionsFromItem(EBBlocks.GRANITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GRANITE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.GRANITE_BRICKS))
                .criterion(hasItem(EBBlocks.GRANITE_BRICKS), conditionsFromItem(EBBlocks.GRANITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.GRANITE_BRICK_WALL, 6,
                Ingredient.ofItems(EBBlocks.GRANITE_BRICKS))
                .criterion(hasItem(EBBlocks.GRANITE_BRICKS), conditionsFromItem(EBBlocks.GRANITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.GRANITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.ANDESITE_BRICKS, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.ANDESITE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANDESITE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.ANDESITE_BRICKS))
                .criterion(hasItem(EBBlocks.ANDESITE_BRICKS), conditionsFromItem(EBBlocks.ANDESITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANDESITE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ANDESITE_BRICKS))
                .criterion(hasItem(EBBlocks.ANDESITE_BRICKS), conditionsFromItem(EBBlocks.ANDESITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.ANDESITE_BRICK_WALL, 6,
                Ingredient.ofItems(EBBlocks.ANDESITE_BRICKS))
                .criterion(hasItem(EBBlocks.ANDESITE_BRICKS), conditionsFromItem(EBBlocks.ANDESITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ANDESITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.DIORITE_BRICKS, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.DIORITE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DIORITE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.DIORITE_BRICKS))
                .criterion(hasItem(EBBlocks.DIORITE_BRICKS), conditionsFromItem(EBBlocks.DIORITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DIORITE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.DIORITE_BRICKS))
                .criterion(hasItem(EBBlocks.DIORITE_BRICKS), conditionsFromItem(EBBlocks.DIORITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.DIORITE_BRICK_WALL, 6,
                Ingredient.ofItems(EBBlocks.DIORITE_BRICKS))
                .criterion(hasItem(EBBlocks.DIORITE_BRICKS), conditionsFromItem(EBBlocks.DIORITE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DIORITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_BRICKS, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.SMOOTH_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.SMOOTH_BRICKS))
                .criterion(hasItem(EBBlocks.SMOOTH_BRICKS), conditionsFromItem(EBBlocks.SMOOTH_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SMOOTH_BRICKS))
                .criterion(hasItem(EBBlocks.SMOOTH_BRICKS), conditionsFromItem(EBBlocks.SMOOTH_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HERRINGBONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.HERRINGBONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_HERRINGBONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_HERRINGBONE_BRICKS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, EBBlocks.REACHING_LANTERN, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.REACHING_LANTERN)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.BRIMSTONE, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE)));
        ...
        createStairsRecipe(EBBlocks.BRIMSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.BRIMSTONE))
                .criterion(hasItem(EBBlocks.BRIMSTONE), conditionsFromItem(EBBlocks.BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.BRIMSTONE))
                .criterion(hasItem(EBBlocks.BRIMSTONE), conditionsFromItem(EBBlocks.BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.BRIMSTONE_WALL, 6,
                Ingredient.ofItems(EBBlocks.BRIMSTONE))
                .criterion(hasItem(EBBlocks.BRIMSTONE), conditionsFromItem(EBBlocks.BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_BRIMSTONE, 4,
                Ingredient.ofItems(EBBlocks.BRIMSTONE))
                .criterion(hasItem(EBBlocks.BRIMSTONE), conditionsFromItem(EBBlocks.BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BRIMSTONE)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_BRIMSTONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BRIMSTONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_BRIMSTONE_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_BRIMSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_BRIMSTONE), conditionsFromItem(EBBlocks.POLISHED_BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BRIMSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_BRIMSTONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_BRIMSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_BRIMSTONE), conditionsFromItem(EBBlocks.POLISHED_BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_BRIMSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.BRIMSTONE_BRICKS, 4,
                Ingredient.ofItems(EBBlocks.POLISHED_BRIMSTONE))
                .criterion(hasItem(EBBlocks.POLISHED_BRIMSTONE), conditionsFromItem(EBBlocks.POLISHED_BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.BRIMSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.BRIMSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.BRIMSTONE_BRICKS), conditionsFromItem(EBBlocks.BRIMSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.BRIMSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.BRIMSTONE_BRICKS), conditionsFromItem(EBBlocks.BRIMSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.BRIMSTONE_TILES, 4,
                Ingredient.ofItems(EBBlocks.BRIMSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.BRIMSTONE_BRICKS), conditionsFromItem(EBBlocks.BRIMSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_TILES)));
        ...
        createStairsRecipe(EBBlocks.BRIMSTONE_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.BRIMSTONE_TILES))
                .criterion(hasItem(EBBlocks.BRIMSTONE_TILES), conditionsFromItem(EBBlocks.BRIMSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.BRIMSTONE_TILES))
                .criterion(hasItem(EBBlocks.BRIMSTONE_TILES), conditionsFromItem(EBBlocks.BRIMSTONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_TILE_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_PILLAR, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_LAMP, 4)
                ...
                .pattern("@#@")
                .criterion(hasItem(EBBlocks.POLISHED_BRIMSTONE), conditionsFromItem(EBBlocks.POLISHED_BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_LAMP)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_WINDOW, 4)
                ...
                .pattern("@#@")
                .criterion(hasItem(EBBlocks.POLISHED_BRIMSTONE), conditionsFromItem(EBBlocks.POLISHED_BRIMSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BRIMSTONE_WINDOW)));
        ...
        createStairsRecipe(EBBlocks.ASPHALT_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ASPHALT_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ASPHALT_SLAB,
                Ingredient.ofItems(EBBlocks.ASPHALT))
                .criterion(hasItem(EBBlocks.ASPHALT), conditionsFromItem(EBBlocks.ASPHALT))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ASPHALT_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ASPHALT_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ASPHALT))
                .criterion(hasItem(EBBlocks.ASPHALT), conditionsFromItem(EBBlocks.ASPHALT))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ASPHALT_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_STONE_BRICKS, 4,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.SMOOTH_STONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.SMOOTH_STONE_BRICKS))
                .criterion(hasItem(EBBlocks.SMOOTH_STONE_BRICKS), conditionsFromItem(EBBlocks.SMOOTH_STONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_STONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SMOOTH_STONE_BRICKS))
                .criterion(hasItem(EBBlocks.SMOOTH_STONE_BRICKS), conditionsFromItem(EBBlocks.SMOOTH_STONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_STONE_TILES, 4,
                Ingredient.ofItems(EBBlocks.SMOOTH_STONE_BRICKS))
                .criterion(hasItem(EBBlocks.SMOOTH_STONE_BRICKS), conditionsFromItem(EBBlocks.SMOOTH_STONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_TILES)));
        ...
        createStairsRecipe(EBBlocks.SMOOTH_STONE_TILE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_TILE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_TILE_SLAB,
                Ingredient.ofItems(EBBlocks.SMOOTH_STONE_TILES))
                .criterion(hasItem(EBBlocks.SMOOTH_STONE_TILES), conditionsFromItem(EBBlocks.SMOOTH_STONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_STONE_TILE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.SMOOTH_STONE_TILES))
                .criterion(hasItem(EBBlocks.SMOOTH_STONE_TILES), conditionsFromItem(EBBlocks.SMOOTH_STONE_TILES))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_TILE_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_PILLAR, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SMOOTH_STONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SMOOTH_STONE_BRICKS, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHISELED_SMOOTH_STONE_BRICKS)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.POLISHED_STONE, 4,
                ...
                .criterion(hasItem(Blocks.STONE), conditionsFromItem(Blocks.STONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_STONE)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_STONE_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_STONE_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_STONE_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_STONE))
                .criterion(hasItem(EBBlocks.POLISHED_STONE), conditionsFromItem(EBBlocks.POLISHED_STONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_STONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_STONE_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_STONE))
                .criterion(hasItem(EBBlocks.POLISHED_STONE), conditionsFromItem(EBBlocks.POLISHED_STONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_STONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.REDSTONE_BRICKS, 1,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.REDSTONE_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.REDSTONE_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.REDSTONE_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.REDSTONE_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.REDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.REDSTONE_BRICKS), conditionsFromItem(EBBlocks.REDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.REDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.REDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.REDSTONE_BRICKS))
                .criterion(hasItem(EBBlocks.REDSTONE_BRICKS), conditionsFromItem(EBBlocks.REDSTONE_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.REDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createShelfBlock(EBBlocks.OAK_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.OAK_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.SPRUCE_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SPRUCE_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.BIRCH_DECORATIVE_SHELF, 1,
                Ingredient.ofItems(EBBlocks.BIRCH_MOSAIC), Ingredient.ofItems(Items.BOOK))
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BIRCH_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.JUNGLE_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.JUNGLE_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.ACACIA_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ACACIA_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.DARK_OAK_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.DARK_OAK_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.MANGROVE_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.MANGROVE_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.CHERRY_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CHERRY_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.BAMBOO_DECORATIVE_SHELF, 1,
                Ingredient.ofItems(Blocks.BAMBOO_MOSAIC), Ingredient.ofItems(Items.BOOK))
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.BAMBOO_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.CRIMSON_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.CRIMSON_DECORATIVE_SHELF)));
        ...
        createShelfBlock(EBBlocks.WARPED_DECORATIVE_SHELF, 1,
                ...
                .criterion(hasItem(Items.BOOK), conditionsFromItem(Items.BOOK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WARPED_DECORATIVE_SHELF)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, EBBlocks.WEEPING_CANDLE, 1)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.WEEPING_CANDLE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, EBBlocks.TWISTING_CANDLE, 1)
                ...
                .pattern("#")
                .criterion(hasItem(Items.HONEYCOMB), conditionsFromItem(Items.HONEYCOMB))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TWISTING_CANDLE)));
        ...
        createStairsRecipe(EBBlocks.ALMENTRA_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ALMENTRA_SLAB,
                Ingredient.ofItems(EBBlocks.ALMENTRA))
                .criterion(hasItem(EBBlocks.ALMENTRA), conditionsFromItem(EBBlocks.ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ALMENTRA_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ALMENTRA))
                .criterion(hasItem(EBBlocks.ALMENTRA), conditionsFromItem(EBBlocks.ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.POLISHED_ALMENTRA,
                Ingredient.ofItems(EBBlocks.ALMENTRA))
                .criterion(hasItem(EBBlocks.ALMENTRA), conditionsFromItem(EBBlocks.ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_ALMENTRA)));
        ...
        createStairsRecipe(EBBlocks.POLISHED_ALMENTRA_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_ALMENTRA_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_ALMENTRA_SLAB,
                Ingredient.ofItems(EBBlocks.POLISHED_ALMENTRA))
                .criterion(hasItem(EBBlocks.POLISHED_ALMENTRA), conditionsFromItem(EBBlocks.POLISHED_ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_ALMENTRA_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_ALMENTRA_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.POLISHED_ALMENTRA))
                .criterion(hasItem(EBBlocks.POLISHED_ALMENTRA), conditionsFromItem(EBBlocks.POLISHED_ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.POLISHED_ALMENTRA_VERTICAL_STAIRS)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createFourForFourWendysMealRecipe(EBBlocks.getDyedPolishedAlmentra(colors.getId()),
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedPolishedAlmentra(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createStairsRecipe(EBBlocks.getDyedPolishedAlmentraStairs(colors.getId()),
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedPolishedAlmentraStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedPolishedAlmentraSlab(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedPolishedAlmentraSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedPolishedAlmentraVerticalStairs(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedPolishedAlmentraVerticalStairs(colors.getId()))));
        }

        createFourForFourWendysMealRecipe(EBBlocks.ALMENTRA_BRICKS,
                Ingredient.ofItems(EBBlocks.POLISHED_ALMENTRA))
                .criterion(hasItem(EBBlocks.POLISHED_ALMENTRA), conditionsFromItem(EBBlocks.POLISHED_ALMENTRA))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_BRICKS)));
        ...
        createStairsRecipe(EBBlocks.ALMENTRA_BRICK_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_BRICK_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ALMENTRA_BRICK_SLAB,
                Ingredient.ofItems(EBBlocks.ALMENTRA_BRICKS))
                .criterion(hasItem(EBBlocks.ALMENTRA_BRICKS), conditionsFromItem(EBBlocks.ALMENTRA_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ALMENTRA_BRICK_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.ALMENTRA_BRICKS))
                .criterion(hasItem(EBBlocks.ALMENTRA_BRICKS), conditionsFromItem(EBBlocks.ALMENTRA_BRICKS))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.ALMENTRA_BRICK_VERTICAL_STAIRS)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createFourForFourWendysMealRecipe(EBBlocks.getDyedAlmentraBricks(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraBricks(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createStairsRecipe(EBBlocks.getDyedAlmentraBrickStairs(colors.getId()),
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraBrickStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedAlmentraBrickSlab(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedAlmentraBricks(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraBrickSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedAlmentraBrickVerticalStairs(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedAlmentraBricks(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraBrickVerticalStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            ...
            .criterion(hasItem(EBBlocks.getDyedTerracottaTiles(colors.getId())), conditionsFromItem(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedTerracottaTiles(colors.getId())) + "_from_base"));
        }

        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedAlmentra(colors.getId()), EBBlocks.ALMENTRA, DyeItem.byColor(colors).getColor())
            .criterion(hasItem(EBBlocks.getDyedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentra(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedPolishedAlmentra(colors.getId()), EBBlocks.POLISHED_ALMENTRA, DyeItem.byColor(colors).getColor())
                    .criterion(hasItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedPolishedAlmentra(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedAlmentraBricks(colors.getId()), EBBlocks.ALMENTRA_BRICKS, DyeItem.byColor(colors).getColor())
                    .criterion(hasItem(EBBlocks.getDyedAlmentraBricks(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraBricks(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingTagRecipe(EBBlocks.getDyedKnittedWools(colors.getId()), EBTags.Items.KNITTED_WOOL, DyeItem.byColor(colors).getColor())
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(colors.getId())) + "_from_any"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingTagRecipe(EBBlocks.getDyedKnittedCarpets(colors.getId()), EBTags.Items.KNITTED_CARPET, DyeItem.byColor(colors).getColor())
                    ...
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedCarpets(colors.getId())) + "_from_any"));
        }
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.WHITE.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.WHITE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BLACK.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BLACK.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.PINK.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.PINK.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.MAGENTA.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.MAGENTA.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.PURPLE.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.PURPLE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BLUE.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BLUE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_BLUE.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_BLUE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.CYAN.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.CYAN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.GREEN.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.GREEN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIME.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIME.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.YELLOW.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.YELLOW.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.ORANGE.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.ORANGE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.RED.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.RED.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BROWN.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BROWN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.GRAY.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.GRAY.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_GRAY.getId()),
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_GRAY.getId()))));
...
//                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TRAPPED_GLOOM_CHEST))));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .criterion(hasItem(EBBlocks.POLISHED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SANDSTONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .criterion(hasItem(EBBlocks.POLISHED_RED_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_RED_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.RED_SANDSTONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .criterion(hasItem(EBBlocks.POLISHED_SOUL_SANDSTONE), conditionsFromItem(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.SOUL_SANDSTONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PAPER_BLOCK, 2)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.PAPER_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_PAPER_BLOCK, 5)
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_PAPER_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_PAPER_BLOCK, 5)
                ...
                .pattern("#@#")
                .criterion(hasItem(EBBlocks.PAPER_BLOCK), conditionsFromItem(EBBlocks.PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THICK_PAPER_BLOCK)));
        ...
        createStairsRecipe(EBBlocks.THIN_PAPER_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_PAPER_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_PAPER_SLAB,
                Ingredient.ofItems(EBBlocks.THIN_PAPER_BLOCK))
                .criterion(hasItem(EBBlocks.THIN_PAPER_BLOCK), conditionsFromItem(EBBlocks.THIN_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_PAPER_SLAB)));

        createVerticalStairsRecipe(EBBlocks.THIN_PAPER_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.THIN_PAPER_BLOCK))
                .criterion(hasItem(EBBlocks.THIN_PAPER_BLOCK), conditionsFromItem(EBBlocks.THIN_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_PAPER_VERTICAL_STAIRS)));
        ...
        createStairsRecipe(EBBlocks.THICK_PAPER_STAIRS,
                ...
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THICK_PAPER_STAIRS)));

        createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_PAPER_SLAB,
                Ingredient.ofItems(EBBlocks.THICK_PAPER_BLOCK))
                .criterion(hasItem(EBBlocks.THICK_PAPER_BLOCK), conditionsFromItem(EBBlocks.THICK_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THICK_PAPER_SLAB)));

        createVerticalStairsRecipe(EBBlocks.THICK_PAPER_VERTICAL_STAIRS,
                Ingredient.ofItems(EBBlocks.THICK_PAPER_BLOCK))
                .criterion(hasItem(EBBlocks.THICK_PAPER_BLOCK), conditionsFromItem(EBBlocks.THICK_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THICK_PAPER_VERTICAL_STAIRS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_DIAGONAL_PAPER_BLOCK, 6)
                ...
                .pattern("#@@")
                .criterion(hasItem(EBBlocks.THIN_PAPER_BLOCK), conditionsFromItem(EBBlocks.THIN_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_DIAGONAL_PAPER_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_DIVIDED_PAPER_BLOCK, 6)
                ...
                .pattern("@#@")
                .criterion(hasItem(EBBlocks.THIN_PAPER_BLOCK), conditionsFromItem(EBBlocks.THIN_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THIN_DIVIDED_PAPER_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_DIAGONAL_PAPER_BLOCK, 6)
                ...
                .pattern("#@@")
                .criterion(hasItem(EBBlocks.THICK_PAPER_BLOCK), conditionsFromItem(EBBlocks.THICK_PAPER_BLOCK))
                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.THICK_DIAGONAL_PAPER_BLOCK)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createStairsRecipe(EBBlocks.getDyedAlmentraStairs(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedAlmentra(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedAlmentraSlab(colors.getId()),
                    Ingredient.ofItems(EBBlocks.getDyedAlmentra(colors.getId())))
                    .criterion(hasItem(EBBlocks.getDyedAlmentra(colors.getId())), conditionsFromItem(EBBlocks.getDyedAlmentra(colors.getId())))
                    .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.getDyedAlmentraSlab(colors.getId()))));
        }
