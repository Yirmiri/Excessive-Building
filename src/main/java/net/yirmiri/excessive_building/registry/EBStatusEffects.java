...
import net.yirmiri.excessive_building.effect.ConcussionEffect;
...
public class EBStatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> CONCUSSION = register("concussion", new ConcussionEffect(StatusEffectCategory.HARMFUL, 0xe5e242).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, Identifier.of(ExcessiveBuilding.MOD_ID, "effect.concussion"), 0.0, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
