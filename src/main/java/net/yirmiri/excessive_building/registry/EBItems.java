...
public class EBItems {
    ...
    //SHERDS
    public static final Item ROYALTY_POTTERY_SHERD = register("royalty_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item ANCIENT_POTTERY_SHERD = register("ancient_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    ...
    public static final Item BUSTLING_POTTERY_SHERD = register("bustling_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item CHECKERED_POTTERY_SHERD = register("checkered_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item DECAY_POTTERY_SHERD = register("decay_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    ...
    public static final Item HEXXED_POTTERY_SHERD = register("hexxed_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item KITTEH_POTTERY_SHERD = register("kitteh_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item LIFE_POTTERY_SHERD = register("life_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item MESMERIZE_POTTERY_SHERD = register("mesmerize_pottery_sherd", new Item(EBProperties.ItemP.GENERIC));
    public static final Item PORTAL_POTTERY_SHERD = register("portal_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item POTTERY_POTTERY_SHERD = register("pottery_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item RING_POTTERY_SHERD = register("ring_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item SNOUT_POTTERY_SHERD = register("snout_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item SPRITE_POTTERY_SHERD = register("sprite_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item TWINS_POTTERY_SHERD = register("twins_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item WRATHFUL_POTTERY_SHERD = register("wrathful_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item IS_THAT_POTTERY_SHERD = register("is_that_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
    public static final Item KOKOS_BUG_POTTERY_SHERD = register("kokos_bug_pottery_sherd", new Item(EBProperties.ItemP.GENERIC)); //TODO: LT
