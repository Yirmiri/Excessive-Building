...
public class HammerableVerticalStairsBlock extends VerticalStairsBlock {
    public static int maxVariants;
    public static final IntProperty VARIANT = IntProperty.of("variant", 0, maxVariants);

    public HammerableVerticalStairsBlock(int maxVariants, AbstractBlock.Settings settings) {
        super(settings);
