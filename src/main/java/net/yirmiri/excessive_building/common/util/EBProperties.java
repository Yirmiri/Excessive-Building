...
public class EBProperties {
    public static class BlockP {
        ...
        public static final Block.Settings ALMENTRA = FabricBlockSettings.copyOf(Blocks.DRIPSTONE_BLOCK).sounds(BlockSoundGroup.DRIPSTONE_BLOCK).mapColor(MapColor.RAW_IRON_PINK);
        public static final Block.Settings POLISHED_ALMENTRA = FabricBlockSettings.copyOf(Blocks.DRIPSTONE_BLOCK).sounds(BlockSoundGroup.POLISHED_DEEPSLATE).mapColor(MapColor.RAW_IRON_PINK);
