...
public class EBTags {
    public static class Blocks {
        ...
        private static TagKey<Block> create(String id) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, id));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> create(String id) {
            return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, id));
        }
    }
    ...
    public static class PaintingVariants {
        ...
        private static TagKey<PaintingVariant> create(String id) {
            return TagKey.create(Registries.PAINTING_VARIANT, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, id));
        }
    }
}
