...
public class EBSounds {
    ...
    private static SoundEvent register(String id) {
        return Registry.register(BuiltInRegistries.SOUND_EVENT, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, id), SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, id)));
    }
