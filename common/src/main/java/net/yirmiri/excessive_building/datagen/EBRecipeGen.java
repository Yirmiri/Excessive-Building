...
public class EBRecipeGen extends FabricRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> exporter) {
        createTwoByTwoRecipe(EBBlocks.CHISELED_OAK_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_OAK_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_SPRUCE_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_SPRUCE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_BIRCH_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_BIRCH_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_JUNGLE_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_JUNGLE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_ACACIA_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_ACACIA_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_DARK_OAK_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_DARK_OAK_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_MANGROVE_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_MANGROVE_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_CHERRY_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_CHERRY_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_BAMBOO_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_BAMBOO_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_CRIMSON_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_CRIMSON_PLANKS)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_WARPED_PLANKS, 2,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_WARPED_PLANKS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OAK_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_MOSAIC)));
        ...
        stairBuilder(EBBlocks.OAK_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OAK_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.OAK_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.OAK_MOSAIC), has(EBBlocks.OAK_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.OAK_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.OAK_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.OAK_MOSAIC), has(EBBlocks.OAK_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_MOSAIC_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BAMBOO_MOSAIC_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SPRUCE_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_MOSAIC)));
        ...
        stairBuilder(EBBlocks.SPRUCE_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SPRUCE_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.SPRUCE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.SPRUCE_MOSAIC), has(EBBlocks.SPRUCE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SPRUCE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SPRUCE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.SPRUCE_MOSAIC), has(EBBlocks.SPRUCE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BIRCH_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_MOSAIC)));
        ...
        stairBuilder(EBBlocks.BIRCH_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BIRCH_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.BIRCH_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.BIRCH_MOSAIC), has(EBBlocks.BIRCH_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BIRCH_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.BIRCH_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.BIRCH_MOSAIC), has(EBBlocks.BIRCH_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.JUNGLE_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_MOSAIC)));
        ...
        stairBuilder(EBBlocks.JUNGLE_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.JUNGLE_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.JUNGLE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.JUNGLE_MOSAIC), has(EBBlocks.JUNGLE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.JUNGLE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.JUNGLE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.JUNGLE_MOSAIC), has(EBBlocks.JUNGLE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ACACIA_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_MOSAIC)));
        ...
        stairBuilder(EBBlocks.ACACIA_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ACACIA_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.ACACIA_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.ACACIA_MOSAIC), has(EBBlocks.ACACIA_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ACACIA_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ACACIA_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.ACACIA_MOSAIC), has(EBBlocks.ACACIA_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DARK_OAK_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_MOSAIC)));
        ...
        stairBuilder(EBBlocks.DARK_OAK_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DARK_OAK_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.DARK_OAK_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.DARK_OAK_MOSAIC), has(EBBlocks.DARK_OAK_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DARK_OAK_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.DARK_OAK_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.DARK_OAK_MOSAIC), has(EBBlocks.DARK_OAK_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MANGROVE_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_MOSAIC)));
        ...
        stairBuilder(EBBlocks.MANGROVE_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MANGROVE_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.MANGROVE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.MANGROVE_MOSAIC), has(EBBlocks.MANGROVE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.MANGROVE_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.MANGROVE_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.MANGROVE_MOSAIC), has(EBBlocks.MANGROVE_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHERRY_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_MOSAIC)));
        ...
        stairBuilder(EBBlocks.CHERRY_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHERRY_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.CHERRY_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.CHERRY_MOSAIC), has(EBBlocks.CHERRY_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.CHERRY_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.CHERRY_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.CHERRY_MOSAIC), has(EBBlocks.CHERRY_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRIMSON_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_MOSAIC)));
        ...
        stairBuilder(EBBlocks.CRIMSON_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRIMSON_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.CRIMSON_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.CRIMSON_MOSAIC), has(EBBlocks.CRIMSON_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.CRIMSON_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.CRIMSON_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.CRIMSON_MOSAIC), has(EBBlocks.CRIMSON_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WARPED_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_MOSAIC)));
        ...
        stairBuilder(EBBlocks.WARPED_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WARPED_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.WARPED_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.WARPED_MOSAIC), has(EBBlocks.WARPED_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WARPED_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WARPED_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.WARPED_MOSAIC), has(EBBlocks.WARPED_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_MOSAIC_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.COBBLESTONE_BRICKS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLESTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.COBBLESTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLESTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLESTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.COBBLESTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.COBBLESTONE_BRICKS), has(EBBlocks.COBBLESTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLESTONE_BRICK_SLAB)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.MOSSY_COBBLESTONE_BRICKS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.MOSSY_COBBLESTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.MOSSY_COBBLESTONE_BRICKS), has(EBBlocks.MOSSY_COBBLESTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSSY_COBBLESTONE_BRICK_SLAB)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.COBBLED_DEEPSLATE_BRICKS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLED_DEEPSLATE_BRICKS)));
        ...
        stairBuilder(EBBlocks.COBBLED_DEEPSLATE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLED_DEEPSLATE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLED_DEEPSLATE_BRICK_SLAB,
                Ingredient.of(EBBlocks.COBBLED_DEEPSLATE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.COBBLED_DEEPSLATE_BRICKS), has(EBBlocks.COBBLED_DEEPSLATE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLED_DEEPSLATE_BRICK_SLAB)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.BLACKSTONE_BRICKS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BLACKSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.BLACKSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BLACKSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BLACKSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.BLACKSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BLACKSTONE_BRICKS), has(EBBlocks.BLACKSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BLACKSTONE_BRICK_SLAB)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_MOSAIC)));
        ...
        stairBuilder(EBBlocks.ANCIENT_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.ANCIENT_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_MOSAIC), has(EBBlocks.ANCIENT_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANCIENT_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ANCIENT_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_MOSAIC), has(EBBlocks.ANCIENT_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_PLANKS, 4)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_PLANKS)));
        ...
        stairBuilder(EBBlocks.ANCIENT_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_SLAB,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANCIENT_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_VERTICAL_STAIRS)));

        fenceBuilder(EBBlocks.ANCIENT_FENCE,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_FENCE)));

        fenceGateBuilder(EBBlocks.ANCIENT_FENCE_GATE,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_FENCE_GATE)));

        doorBuilder(EBBlocks.ANCIENT_DOOR,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_DOOR)));

        trapdoorBuilder(EBBlocks.ANCIENT_TRAPDOOR,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_TRAPDOOR)));

        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, EBBlocks.ANCIENT_PRESSURE_PLATE, 1)
                .define('#', EBBlocks.ANCIENT_PLANKS)
                .pattern("##")
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_PRESSURE_PLATE)));

        ShapelessRecipeBuilder.shapeless(RecipeCategory.REDSTONE, EBBlocks.ANCIENT_BUTTON, 1)
                .requires(EBBlocks.ANCIENT_PLANKS)
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_BUTTON)));

        signBuilder(EBItems.ANCIENT_SIGN,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBItems.ANCIENT_SIGN)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_ANCIENT_PLANKS, 2,
                ...
                .unlockedBy(getHasName(EBBlocks.ANCIENT_SLAB), has(EBBlocks.ANCIENT_SLAB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_ANCIENT_PLANKS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GLOOM_MOSAIC, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_MOSAIC)));
        ...
        stairBuilder(EBBlocks.GLOOM_MOSAIC_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_MOSAIC_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GLOOM_MOSAIC_SLAB,
                Ingredient.of(EBBlocks.GLOOM_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.GLOOM_MOSAIC), has(EBBlocks.GLOOM_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_MOSAIC_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GLOOM_MOSAIC_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.GLOOM_MOSAIC))
                .unlockedBy(getHasName(EBBlocks.GLOOM_MOSAIC), has(EBBlocks.GLOOM_MOSAIC))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_MOSAIC_VERTICAL_STAIRS)));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GLOOM_PLANKS, 4)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_PLANKS)));
        ...
        stairBuilder(EBBlocks.GLOOM_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GLOOM_SLAB,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GLOOM_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_VERTICAL_STAIRS)));

        fenceBuilder(EBBlocks.GLOOM_FENCE,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_FENCE)));

        fenceGateBuilder(EBBlocks.GLOOM_FENCE_GATE,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_FENCE_GATE)));

        doorBuilder(EBBlocks.GLOOM_DOOR,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_DOOR)));

        trapdoorBuilder(EBBlocks.GLOOM_TRAPDOOR,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_TRAPDOOR)));

        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, EBBlocks.GLOOM_PRESSURE_PLATE, 1)
                .define('#', EBBlocks.GLOOM_PLANKS)
                .pattern("##")
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_PRESSURE_PLATE)));

        ShapelessRecipeBuilder.shapeless(RecipeCategory.REDSTONE, EBBlocks.GLOOM_BUTTON, 1)
                .requires(EBBlocks.GLOOM_PLANKS)
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_BUTTON)));

        signBuilder(EBItems.GLOOM_SIGN,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBItems.GLOOM_SIGN)));
        ...
        createTwoByTwoRecipe(EBBlocks.CHISELED_GLOOM_PLANKS, 2,
                ...
                .unlockedBy(getHasName(EBBlocks.GLOOM_SLAB), has(EBBlocks.GLOOM_SLAB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_GLOOM_PLANKS)));

        createFourForFourWendysMealRecipe(EBBlocks.COPPER_BRICKS,
                Ingredient.of(Blocks.COPPER_BLOCK))
                .unlockedBy(getHasName(Blocks.COPPER_BLOCK), has(Blocks.COPPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(Blocks.COPPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(EBBlocks.COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS)));
        
        createFourForFourWendysMealRecipe(EBBlocks.EXPOSED_COPPER_BRICKS,
                Ingredient.of(Blocks.EXPOSED_COPPER))
                .unlockedBy(getHasName(Blocks.EXPOSED_COPPER), has(Blocks.EXPOSED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EXPOSED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.EXPOSED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.EXPOSED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.EXPOSED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.EXPOSED_COPPER_BRICKS), has(EBBlocks.EXPOSED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.EXPOSED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.EXPOSED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.EXPOSED_COPPER_BRICKS), has(EBBlocks.EXPOSED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EXPOSED_COPPER_BRICK_VERTICAL_STAIRS)));
        
        createFourForFourWendysMealRecipe(EBBlocks.WEATHERED_COPPER_BRICKS,
                Ingredient.of(Blocks.WEATHERED_COPPER))
                .unlockedBy(getHasName(Blocks.WEATHERED_COPPER), has(Blocks.WEATHERED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEATHERED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.WEATHERED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WEATHERED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.WEATHERED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WEATHERED_COPPER_BRICKS), has(EBBlocks.WEATHERED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WEATHERED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WEATHERED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WEATHERED_COPPER_BRICKS), has(EBBlocks.WEATHERED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEATHERED_COPPER_BRICK_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.OXIDIZED_COPPER_BRICKS,
                Ingredient.of(Blocks.OXIDIZED_COPPER))
                .unlockedBy(getHasName(Blocks.OXIDIZED_COPPER), has(Blocks.OXIDIZED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OXIDIZED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.OXIDIZED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.OXIDIZED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.OXIDIZED_COPPER_BRICKS), has(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.OXIDIZED_COPPER_BRICKS), has(EBBlocks.OXIDIZED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.WAXED_COPPER_BRICKS,
                Ingredient.of(Blocks.WAXED_COPPER_BLOCK))
                .unlockedBy(getHasName(Blocks.WAXED_COPPER_BLOCK), has(Blocks.WAXED_COPPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.WAXED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.WAXED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_COPPER_BRICKS), has(EBBlocks.WAXED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WAXED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_COPPER_BRICKS), has(EBBlocks.WAXED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS,
                Ingredient.of(Blocks.WAXED_EXPOSED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_EXPOSED_COPPER), has(Blocks.WAXED_EXPOSED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS), has(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS), has(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS,
                Ingredient.of(Blocks.WAXED_WEATHERED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_WEATHERED_COPPER), has(Blocks.WAXED_WEATHERED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS), has(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS), has(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS)));

        createFourForFourWendysMealRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS,
                Ingredient.of(Blocks.WAXED_OXIDIZED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_OXIDIZED_COPPER), has(Blocks.WAXED_OXIDIZED_COPPER))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS)));
        ...
        stairBuilder(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB,
                Ingredient.of(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS), has(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .unlockedBy(getHasName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS), has(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS)));

        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.COPPER_BRICKS, Blocks.COPPER_BLOCK, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.EXPOSED_COPPER_BRICKS, Blocks.EXPOSED_COPPER, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.WEATHERED_COPPER_BRICKS, Blocks.WEATHERED_COPPER, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.OXIDIZED_COPPER_BRICKS, Blocks.OXIDIZED_COPPER, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_COPPER_BRICKS, Blocks.WAXED_COPPER_BLOCK, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_EXPOSED_COPPER_BRICKS, Blocks.WAXED_EXPOSED_COPPER, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_WEATHERED_COPPER_BRICKS, Blocks.WAXED_WEATHERED_COPPER, 4);
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS, Blocks.WAXED_OXIDIZED_COPPER, 4);
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICKS, 1, Ingredient.of(EBBlocks.COPPER_BRICKS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(EBBlocks.COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICKS) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_SLAB, 1, Ingredient.of(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS, 1, Ingredient.of(EBBlocks.COPPER_BRICKS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(EBBlocks.COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_STAIRS), has(EBBlocks.COPPER_BRICK_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB, 1, Ingredient.of(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_SLAB), has(EBBlocks.COPPER_BRICK_SLAB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), has(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS, 1, Ingredient.of(EBBlocks.COPPER_BRICKS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(EBBlocks.COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_STAIRS), has(EBBlocks.COPPER_BRICK_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB, 1, Ingredient.of(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_SLAB), has(EBBlocks.COPPER_BRICK_SLAB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), has(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS, 1, Ingredient.of(EBBlocks.COPPER_BRICKS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICKS), has(EBBlocks.COPPER_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICKS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_STAIRS), has(EBBlocks.COPPER_BRICK_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_STAIRS) + "_from_honeycomb"));
        
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB, 1, Ingredient.of(EBBlocks.COPPER_BRICK_SLAB.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_SLAB), has(EBBlocks.COPPER_BRICK_SLAB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_SLAB) + "_from_honeycomb"));
        ...
        createWaxedRecipe(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS, 1, Ingredient.of(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS.asItem()))
                .unlockedBy(getHasName(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS), has(EBBlocks.COPPER_BRICK_VERTICAL_STAIRS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_COPPER_BRICK_VERTICAL_STAIRS) + "_from_honeycomb"));

        createTwoByTwoRecipe(EBBlocks.IRON_BRICKS, 1,
                Ingredient.of(Items.IRON_INGOT))
                .unlockedBy(getHasName(Items.IRON_INGOT), has(Items.IRON_INGOT))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.IRON_BRICKS)));
        ...
        stairBuilder(EBBlocks.IRON_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.IRON_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.IRON_BRICK_SLAB,
                Ingredient.of(EBBlocks.IRON_BRICKS))
                .unlockedBy(getHasName(EBBlocks.IRON_BRICKS), has(EBBlocks.IRON_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.IRON_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.IRON_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.IRON_BRICKS))
                .unlockedBy(getHasName(EBBlocks.IRON_BRICKS), has(EBBlocks.IRON_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.IRON_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.EMERALD_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EMERALD_BRICKS)));
        ...
        stairBuilder(EBBlocks.EMERALD_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EMERALD_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.EMERALD_BRICK_SLAB,
                Ingredient.of(EBBlocks.EMERALD_BRICKS))
                .unlockedBy(getHasName(EBBlocks.EMERALD_BRICKS), has(EBBlocks.EMERALD_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EMERALD_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.EMERALD_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.EMERALD_BRICKS))
                .unlockedBy(getHasName(EBBlocks.EMERALD_BRICKS), has(EBBlocks.EMERALD_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EMERALD_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.GOLD_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GOLD_BRICKS)));
        ...
        stairBuilder(EBBlocks.GOLD_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GOLD_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GOLD_BRICK_SLAB,
                Ingredient.of(EBBlocks.GOLD_BRICKS))
                .unlockedBy(getHasName(EBBlocks.GOLD_BRICKS), has(EBBlocks.GOLD_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GOLD_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GOLD_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.GOLD_BRICKS))
                .unlockedBy(getHasName(EBBlocks.GOLD_BRICKS), has(EBBlocks.GOLD_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GOLD_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.LAPIS_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.LAPIS_BRICKS)));
        ...
        stairBuilder(EBBlocks.LAPIS_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.LAPIS_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.LAPIS_BRICK_SLAB,
                Ingredient.of(EBBlocks.LAPIS_BRICKS))
                .unlockedBy(getHasName(EBBlocks.LAPIS_BRICKS), has(EBBlocks.LAPIS_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.LAPIS_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.LAPIS_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.LAPIS_BRICKS))
                .unlockedBy(getHasName(EBBlocks.LAPIS_BRICKS), has(EBBlocks.LAPIS_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.LAPIS_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.DIAMOND_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIAMOND_BRICKS)));
        ...
        stairBuilder(EBBlocks.DIAMOND_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIAMOND_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DIAMOND_BRICK_SLAB,
                Ingredient.of(EBBlocks.DIAMOND_BRICKS))
                .unlockedBy(getHasName(EBBlocks.DIAMOND_BRICKS), has(EBBlocks.DIAMOND_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIAMOND_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DIAMOND_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.DIAMOND_BRICKS))
                .unlockedBy(getHasName(EBBlocks.DIAMOND_BRICKS), has(EBBlocks.DIAMOND_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIAMOND_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.NETHERITE_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.NETHERITE_BRICKS)));
        ...
        stairBuilder(EBBlocks.NETHERITE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.NETHERITE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.NETHERITE_BRICK_SLAB,
                Ingredient.of(EBBlocks.NETHERITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.NETHERITE_BRICKS), has(EBBlocks.NETHERITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.NETHERITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.NETHERITE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.NETHERITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.NETHERITE_BRICKS), has(EBBlocks.NETHERITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.NETHERITE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SEA_GLASS, 4)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SEA_GLASS)));
        ...
        createDyeEightRecipe(EBBlocks.SCARLET_SEA_GLASS, 8,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SCARLET_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.VERDANT_SEA_GLASS, 8,
                Ingredient.of(EBBlocks.SEA_GLASS), Ingredient.of(Items.LIME_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS), has(EBBlocks.SEA_GLASS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.VERDANT_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.ROSE_SEA_GLASS, 8,
                Ingredient.of(EBBlocks.SEA_GLASS), Ingredient.of(Items.PINK_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS), has(EBBlocks.SEA_GLASS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ROSE_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.AQUA_SEA_GLASS, 8,
                Ingredient.of(EBBlocks.SEA_GLASS), Ingredient.of(Items.BLUE_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS), has(EBBlocks.SEA_GLASS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.AQUA_SEA_GLASS)));

        createDyeEightRecipe(EBBlocks.FUCHSIA_SEA_GLASS, 8,
                Ingredient.of(EBBlocks.SEA_GLASS), Ingredient.of(Items.MAGENTA_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS), has(EBBlocks.SEA_GLASS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.FUCHSIA_SEA_GLASS)));

        createPaneRecipe(EBBlocks.SEA_GLASS_PANE, 16,
                Ingredient.of(EBBlocks.SEA_GLASS))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS), has(EBBlocks.SEA_GLASS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.SCARLET_SEA_GLASS_PANE, 16,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SCARLET_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.FUCHSIA_SEA_GLASS_PANE, 16,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.FUCHSIA_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.AQUA_SEA_GLASS_PANE, 16,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.AQUA_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.VERDANT_SEA_GLASS_PANE, 16,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.VERDANT_SEA_GLASS_PANE)));
        ...
        createPaneRecipe(EBBlocks.ROSE_SEA_GLASS_PANE, 16,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ROSE_SEA_GLASS_PANE)));
        ...
        createDyeEightRecipe(EBBlocks.SCARLET_SEA_GLASS_PANE, 8,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SCARLET_SEA_GLASS_PANE) + "_from_dye"));

        createDyeEightRecipe(EBBlocks.VERDANT_SEA_GLASS_PANE, 8,
                Ingredient.of(EBBlocks.SEA_GLASS_PANE), Ingredient.of(Items.LIME_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS_PANE), has(EBBlocks.SEA_GLASS_PANE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.VERDANT_SEA_GLASS_PANE) + "_from_dye"));

        createDyeEightRecipe(EBBlocks.ROSE_SEA_GLASS_PANE, 8,
                Ingredient.of(EBBlocks.SEA_GLASS_PANE), Ingredient.of(Items.PINK_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS_PANE), has(EBBlocks.SEA_GLASS_PANE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ROSE_SEA_GLASS_PANE) + "_from_dye"));

        createDyeEightRecipe(EBBlocks.AQUA_SEA_GLASS_PANE, 8,
                Ingredient.of(EBBlocks.SEA_GLASS_PANE), Ingredient.of(Items.BLUE_DYE))
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS_PANE), has(EBBlocks.SEA_GLASS_PANE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.AQUA_SEA_GLASS_PANE) + "_from_dye"));
        ...
        createDyeEightRecipe(EBBlocks.FUCHSIA_SEA_GLASS_PANE, 8,
                ...
                .unlockedBy(getHasName(EBBlocks.SEA_GLASS_PANE), has(EBBlocks.SEA_GLASS_PANE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.FUCHSIA_SEA_GLASS_PANE) + "_from_dye"));
        ...
        createTwoByTwoRecipe(EBBlocks.BONE_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.BONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.BONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BONE_BRICKS), has(EBBlocks.BONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.BONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BONE_BRICKS), has(EBBlocks.BONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BONE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.BONE_BRICK_WALL, 6,
                Ingredient.of(EBBlocks.BONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BONE_BRICKS), has(EBBlocks.BONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BONE_BRICK_WALL)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_MAGMA_BLOCK, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_MAGMA_BLOCK)));
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE)));
        ...
        stairBuilder(EBBlocks.SOUL_SANDSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_SLAB,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE), has(EBBlocks.SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE), has(EBBlocks.SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.SOUL_SANDSTONE_WALL, 6,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE), has(EBBlocks.SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_WALL)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SOUL_SANDSTONE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_SOUL_SANDSTONE)));

        createTwoByTwoRecipe(EBBlocks.CUT_SOUL_SANDSTONE, 4,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE), has(EBBlocks.SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CUT_SOUL_SANDSTONE)));
        ...
        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CUT_SOUL_SANDSTONE_SLAB,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CUT_SOUL_SANDSTONE_SLAB)));
        ...
        stairBuilder(EBBlocks.SMOOTH_SOUL_SANDSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_SOUL_SANDSTONE_SLAB,
                Ingredient.of(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_SOUL_SANDSTONE), has(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_SOUL_SANDSTONE), has(EBBlocks.SMOOTH_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_SOUL_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_SANDSTONE, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SANDSTONE)));
        ...
        stairBuilder(EBBlocks.POLISHED_SANDSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SANDSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_SANDSTONE_SLAB,
                Ingredient.of(EBBlocks.POLISHED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SANDSTONE), has(EBBlocks.POLISHED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SANDSTONE), has(EBBlocks.POLISHED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SANDSTONE_BRICKS, 4,
                Ingredient.of(EBBlocks.POLISHED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SANDSTONE), has(EBBlocks.POLISHED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.SANDSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SANDSTONE_BRICKS), has(EBBlocks.SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SANDSTONE_BRICKS), has(EBBlocks.SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SANDSTONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SANDSTONE_BRICKS, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ENGRAVED_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_SANDSTONE_BRICKS, 2)
                .define('#', EBBlocks.ENGRAVED_SANDSTONE_BRICKS)
                .pattern("#")
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.ENGRAVED_SANDSTONE_BRICKS), has(EBBlocks.ENGRAVED_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DECORATED_SANDSTONE_BRICKS)));
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SANDSTONE_BRICKS, EBBlocks.SANDSTONE_BRICKS, 1);
        ...
        createTwoByTwoRecipe(EBBlocks.SANDSTONE_TILES, 4,
                Ingredient.of(EBBlocks.SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SANDSTONE_BRICKS), has(EBBlocks.SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_TILES)));
        ...
        stairBuilder(EBBlocks.SANDSTONE_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_TILE_SLAB,
                Ingredient.of(EBBlocks.SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SANDSTONE_TILES), has(EBBlocks.SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SANDSTONE_TILES), has(EBBlocks.SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_RED_SANDSTONE, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_RED_SANDSTONE)));
        ...
        stairBuilder(EBBlocks.POLISHED_RED_SANDSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_RED_SANDSTONE_SLAB,
                Ingredient.of(EBBlocks.POLISHED_RED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_RED_SANDSTONE), has(EBBlocks.POLISHED_RED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_RED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_RED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_RED_SANDSTONE), has(EBBlocks.POLISHED_RED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.RED_SANDSTONE_BRICKS, 4,
                Ingredient.of(EBBlocks.POLISHED_RED_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_RED_SANDSTONE), has(EBBlocks.POLISHED_RED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.RED_SANDSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.RED_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.RED_SANDSTONE_BRICKS), has(EBBlocks.RED_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.RED_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.RED_SANDSTONE_BRICKS), has(EBBlocks.RED_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_RED_SANDSTONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_RED_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_RED_SANDSTONE_BRICKS, 2)
                .define('#', EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS)
                .pattern("#")
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS), has(EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DECORATED_RED_SANDSTONE_BRICKS)));
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_RED_SANDSTONE_BRICKS, EBBlocks.RED_SANDSTONE_BRICKS, 1);
        ...
        createTwoByTwoRecipe(EBBlocks.RED_SANDSTONE_TILES, 4,
                Ingredient.of(EBBlocks.RED_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.RED_SANDSTONE_BRICKS), has(EBBlocks.RED_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_TILES)));
        ...
        stairBuilder(EBBlocks.RED_SANDSTONE_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_TILE_SLAB,
                Ingredient.of(EBBlocks.RED_SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.RED_SANDSTONE_TILES), has(EBBlocks.RED_SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.RED_SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.RED_SANDSTONE_TILES), has(EBBlocks.RED_SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_SOUL_SANDSTONE, 4,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE), has(EBBlocks.SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE)));
        ...
        stairBuilder(EBBlocks.POLISHED_SOUL_SANDSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_SOUL_SANDSTONE_SLAB,
                Ingredient.of(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SOUL_SANDSTONE), has(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_SOUL_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SOUL_SANDSTONE), has(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_SOUL_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE_BRICKS, 4,
                Ingredient.of(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SOUL_SANDSTONE), has(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.SOUL_SANDSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE_BRICKS), has(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE_BRICKS), has(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SOUL_SANDSTONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_SOUL_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DECORATED_SOUL_SANDSTONE_BRICKS, 2)
                .define('#', EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS)
                .pattern("#")
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS), has(EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DECORATED_SOUL_SANDSTONE_BRICKS)));
        ...
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.ENGRAVED_SOUL_SANDSTONE_BRICKS, EBBlocks.SOUL_SANDSTONE_BRICKS, 1);
        ...
        createTwoByTwoRecipe(EBBlocks.SOUL_SANDSTONE_TILES, 4,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE_BRICKS), has(EBBlocks.SOUL_SANDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_TILES)));
        ...
        stairBuilder(EBBlocks.SOUL_SANDSTONE_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_TILE_SLAB,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE_TILES), has(EBBlocks.SOUL_SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SOUL_SANDSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SOUL_SANDSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SOUL_SANDSTONE_TILES), has(EBBlocks.SOUL_SANDSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_TILE_VERTICAL_STAIRS)));
        ...
        createLadderRecipe(EBBlocks.SPRUCE_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.BIRCH_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_LADDER)));
        ...
        createLadderRecipe(EBBlocks.JUNGLE_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.ACACIA_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_LADDER)));
        ...
        createLadderRecipe(EBBlocks.DARK_OAK_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_LADDER)));
        ...
        createLadderRecipe(EBBlocks.MANGROVE_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_LADDER)));
        ...
        createLadderRecipe(EBBlocks.CHERRY_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_LADDER)));
        ...
        createLadderRecipe(EBBlocks.BAMBOO_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_LADDER)));
        ...
        createLadderRecipe(EBBlocks.CRIMSON_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_LADDER)));
        ...
        createLadderRecipe(EBBlocks.WARPED_LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_LADDER)));

        createLadderRecipe(EBBlocks.ANCIENT_LADDER,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_LADDER)));

        createLadderRecipe(EBBlocks.GLOOM_LADDER,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_LADDER)));
        ...
        createLadderRecipe(Blocks.LADDER,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(Blocks.LADDER)));

        createTwoByTwoRecipe(EBBlocks.SPRUCE_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.SPRUCE_PLANKS))
                .unlockedBy(getHasName(Blocks.SPRUCE_PLANKS), has(Blocks.SPRUCE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.WARPED_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.WARPED_PLANKS))
                .unlockedBy(getHasName(Blocks.WARPED_PLANKS), has(Blocks.WARPED_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.CRIMSON_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.CRIMSON_PLANKS))
                .unlockedBy(getHasName(Blocks.CRIMSON_PLANKS), has(Blocks.CRIMSON_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.BAMBOO_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.BAMBOO_PLANKS))
                .unlockedBy(getHasName(Blocks.BAMBOO_PLANKS), has(Blocks.BAMBOO_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.CHERRY_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.CHERRY_PLANKS))
                .unlockedBy(getHasName(Blocks.CHERRY_PLANKS), has(Blocks.CHERRY_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.MANGROVE_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.MANGROVE_PLANKS))
                .unlockedBy(getHasName(Blocks.MANGROVE_PLANKS), has(Blocks.MANGROVE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.DARK_OAK_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.DARK_OAK_PLANKS))
                .unlockedBy(getHasName(Blocks.DARK_OAK_PLANKS), has(Blocks.DARK_OAK_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.ACACIA_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.ACACIA_PLANKS))
                .unlockedBy(getHasName(Blocks.ACACIA_PLANKS), has(Blocks.ACACIA_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.JUNGLE_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.JUNGLE_PLANKS))
                .unlockedBy(getHasName(Blocks.JUNGLE_PLANKS), has(Blocks.JUNGLE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.BIRCH_CRAFTING_TABLE, 1,
                Ingredient.of(Blocks.BIRCH_PLANKS))
                .unlockedBy(getHasName(Blocks.BIRCH_PLANKS), has(Blocks.BIRCH_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.ANCIENT_CRAFTING_TABLE, 1,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS), has(EBBlocks.ANCIENT_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_CRAFTING_TABLE)));

        createTwoByTwoRecipe(EBBlocks.GLOOM_CRAFTING_TABLE, 1,
                Ingredient.of(EBBlocks.GLOOM_PLANKS))
                .unlockedBy(getHasName(EBBlocks.GLOOM_PLANKS), has(EBBlocks.GLOOM_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_CRAFTING_TABLE)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.WOODEN_MUG, 3)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WOODEN_MUG)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.GLASS_JAR, 3)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLASS_JAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.GLASS_JAR_OF_FIRE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLASS_JAR_OF_FIRE)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.GLASS_JAR_OF_SOUL_FIRE, 1)
                ...
                .pattern("!")
                .unlockedBy(getHasName(EBBlocks.GLASS_JAR), has(EBBlocks.GLASS_JAR))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLASS_JAR_OF_SOUL_FIRE)));
        ...
        stairBuilder(EBBlocks.QUARTZ_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.QUARTZ_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.QUARTZ_BRICK_SLAB,
                Ingredient.of(Blocks.QUARTZ_BRICKS))
                .unlockedBy(getHasName(Blocks.QUARTZ_BRICKS), has(Blocks.QUARTZ_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.QUARTZ_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.QUARTZ_BRICK_VERTICAL_STAIRS,
                Ingredient.of(Blocks.QUARTZ_BRICKS))
                .unlockedBy(getHasName(Blocks.QUARTZ_BRICKS), has(Blocks.QUARTZ_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.QUARTZ_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.QUARTZ_BRICK_WALL, 6,
                Ingredient.of(Blocks.QUARTZ_BRICKS))
                .unlockedBy(getHasName(Blocks.QUARTZ_BRICKS), has(Blocks.QUARTZ_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.QUARTZ_BRICK_WALL)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            stairBuilder(EBBlocks.getDyedTerracottaTileStairs(colors.getId()),
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTileStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedTerracottaTileSlab(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedTerracottaTiles(colors.getId())), has(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTileSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedTerracottaTileVerticalStairs(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedTerracottaTiles(colors.getId())), has(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTileVerticalStairs(colors.getId()))));
        }
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.TERRACOTTA_TILES, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.TERRACOTTA_TILES)));
        ...
        stairBuilder(EBBlocks.TERRACOTTA_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.TERRACOTTA_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.TERRACOTTA_TILE_SLAB,
                Ingredient.of(EBBlocks.TERRACOTTA_TILES))
                .unlockedBy(getHasName(EBBlocks.TERRACOTTA_TILES), has(EBBlocks.TERRACOTTA_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.TERRACOTTA_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.TERRACOTTA_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.TERRACOTTA_TILES))
                .unlockedBy(getHasName(EBBlocks.TERRACOTTA_TILES), has(EBBlocks.TERRACOTTA_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.TERRACOTTA_TILE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.WHITE.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.WHITE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_GRAY.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_GRAY.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.GRAY.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.GRAY.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BLACK.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BLACK.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BROWN.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BROWN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.RED.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.RED.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.ORANGE.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.ORANGE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.YELLOW.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.YELLOW.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIME.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIME.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.GREEN.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.GREEN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.CYAN.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.CYAN.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_BLUE.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.LIGHT_BLUE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.BLUE.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.BLUE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.PURPLE.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.PURPLE.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.MAGENTA.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.MAGENTA.getId()))));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.getDyedTerracottaTiles(DyeColor.PINK.getId()), 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(DyeColor.PINK.getId()))));

        createVerticalStairsRecipe(EBBlocks.OAK_VERTICAL_STAIRS,
                Ingredient.of(Blocks.OAK_PLANKS))
                .unlockedBy(getHasName(Blocks.OAK_PLANKS), has(Blocks.OAK_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_VERTICAL_STAIRS)));

        createVerticalStairsRecipe(EBBlocks.SPRUCE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.SPRUCE_PLANKS))
                .unlockedBy(getHasName(Blocks.SPRUCE_PLANKS), has(Blocks.SPRUCE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_VERTICAL_STAIRS)));

        createVerticalStairsRecipe(EBBlocks.BIRCH_VERTICAL_STAIRS,
                Ingredient.of(Blocks.BIRCH_PLANKS))
                .unlockedBy(getHasName(Blocks.BIRCH_PLANKS), has(Blocks.BIRCH_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.JUNGLE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.JUNGLE_PLANKS))
                .unlockedBy(getHasName(Blocks.JUNGLE_PLANKS), has(Blocks.JUNGLE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.ACACIA_VERTICAL_STAIRS,
                Ingredient.of(Blocks.ACACIA_PLANKS))
                .unlockedBy(getHasName(Blocks.ACACIA_PLANKS), has(Blocks.ACACIA_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.DARK_OAK_VERTICAL_STAIRS,
                Ingredient.of(Blocks.DARK_OAK_PLANKS))
                .unlockedBy(getHasName(Blocks.DARK_OAK_PLANKS), has(Blocks.DARK_OAK_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.MANGROVE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.MANGROVE_PLANKS))
                .unlockedBy(getHasName(Blocks.MANGROVE_PLANKS), has(Blocks.MANGROVE_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.CHERRY_VERTICAL_STAIRS,
                Ingredient.of(Blocks.CHERRY_PLANKS))
                .unlockedBy(getHasName(Blocks.CHERRY_PLANKS), has(Blocks.CHERRY_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.BAMBOO_VERTICAL_STAIRS,
                Ingredient.of(Blocks.BAMBOO_PLANKS))
                .unlockedBy(getHasName(Blocks.BAMBOO_PLANKS), has(Blocks.BAMBOO_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.CRIMSON_VERTICAL_STAIRS,
                Ingredient.of(Blocks.CRIMSON_PLANKS))
                .unlockedBy(getHasName(Blocks.CRIMSON_PLANKS), has(Blocks.CRIMSON_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_VERTICAL_STAIRS)));
        
        createVerticalStairsRecipe(EBBlocks.WARPED_VERTICAL_STAIRS,
                Ingredient.of(Blocks.WARPED_PLANKS))
                .unlockedBy(getHasName(Blocks.WARPED_PLANKS), has(Blocks.WARPED_PLANKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.STONE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.STONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.COBBLESTONE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.COBBLESTONE))
                .unlockedBy(getHasName(Blocks.COBBLESTONE), has(Blocks.COBBLESTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLESTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.MOSSY_COBBLESTONE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.MOSSY_COBBLESTONE))
                .unlockedBy(getHasName(Blocks.MOSSY_COBBLESTONE), has(Blocks.MOSSY_COBBLESTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSSY_COBBLESTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.STONE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.MOSSY_STONE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSSY_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.COBBLED_DEEPSLATE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.COBBLED_DEEPSLATE))
                .unlockedBy(getHasName(Blocks.COBBLED_DEEPSLATE), has(Blocks.COBBLED_DEEPSLATE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.COBBLED_DEEPSLATE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DEEPSLATE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DEEPSLATE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DEEPSLATE_TILE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DEEPSLATE_TILE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_DEEPSLATE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_DEEPSLATE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.QUARTZ_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.QUARTZ_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_QUARTZ_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_QUARTZ_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.SANDSTONE))
                .unlockedBy(getHasName(Blocks.SANDSTONE), has(Blocks.SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.RED_SANDSTONE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.RED_SANDSTONE))
                .unlockedBy(getHasName(Blocks.RED_SANDSTONE), has(Blocks.RED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_SANDSTONE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.SMOOTH_RED_SANDSTONE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_RED_SANDSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.BLACKSTONE_VERTICAL_STAIRS,
                Ingredient.of(Blocks.BLACKSTONE))
                .unlockedBy(getHasName(Blocks.BLACKSTONE), has(Blocks.BLACKSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BLACKSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_BLACKSTONE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BLACKSTONE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BLACKSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.NETHER_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.NETHER_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.RED_NETHER_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_NETHER_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PRISMARINE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.PRISMARINE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PRISMARINE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.PRISMARINE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DARK_PRISMARINE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_PRISMARINE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.ANDESITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_ANDESITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_ANDESITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.GRANITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_GRANITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_GRANITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.DIORITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.POLISHED_DIORITE_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_DIORITE_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.END_STONE_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.END_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.PURPUR_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.PURPUR_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.EXPOSED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.EXPOSED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WEATHERED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEATHERED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.OXIDIZED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OXIDIZED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_EXPOSED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_EXPOSED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_WEATHERED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_WEATHERED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createVerticalStairsRecipe(EBBlocks.WAXED_OXIDIZED_CUT_COPPER_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WAXED_OXIDIZED_CUT_COPPER_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.GRANITE_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_BRICKS)));
        ...
        stairBuilder(EBBlocks.GRANITE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GRANITE_BRICK_SLAB,
                Ingredient.of(EBBlocks.GRANITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.GRANITE_BRICKS), has(EBBlocks.GRANITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.GRANITE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.GRANITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.GRANITE_BRICKS), has(EBBlocks.GRANITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.GRANITE_BRICK_WALL, 6,
                Ingredient.of(EBBlocks.GRANITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.GRANITE_BRICKS), has(EBBlocks.GRANITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GRANITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.ANDESITE_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_BRICKS)));
        ...
        stairBuilder(EBBlocks.ANDESITE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANDESITE_BRICK_SLAB,
                Ingredient.of(EBBlocks.ANDESITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.ANDESITE_BRICKS), has(EBBlocks.ANDESITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ANDESITE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ANDESITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.ANDESITE_BRICKS), has(EBBlocks.ANDESITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.ANDESITE_BRICK_WALL, 6,
                Ingredient.of(EBBlocks.ANDESITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.ANDESITE_BRICKS), has(EBBlocks.ANDESITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANDESITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.DIORITE_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_BRICKS)));
        ...
        stairBuilder(EBBlocks.DIORITE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.DIORITE_BRICK_SLAB,
                Ingredient.of(EBBlocks.DIORITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.DIORITE_BRICKS), has(EBBlocks.DIORITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.DIORITE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.DIORITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.DIORITE_BRICKS), has(EBBlocks.DIORITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.DIORITE_BRICK_WALL, 6,
                Ingredient.of(EBBlocks.DIORITE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.DIORITE_BRICKS), has(EBBlocks.DIORITE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DIORITE_BRICK_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_BRICKS)));
        ...
        stairBuilder(EBBlocks.SMOOTH_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_BRICK_SLAB,
                Ingredient.of(EBBlocks.SMOOTH_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BRICKS), has(EBBlocks.SMOOTH_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SMOOTH_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BRICKS), has(EBBlocks.SMOOTH_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_BRICK_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.SMOOTH_BRICK_WALL, 6,
                Ingredient.of(EBBlocks.SMOOTH_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BRICKS), has(EBBlocks.SMOOTH_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_BRICK_WALL)));
        ...
        createVerticalStairsRecipe(EBBlocks.MUD_BRICK_VERTICAL_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MUD_BRICK_VERTICAL_STAIRS)));
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.MUD_BRICK_VERTICAL_STAIRS, Blocks.MUD_BRICKS, 1);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HERRINGBONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.HERRINGBONE_BRICKS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_HERRINGBONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_HERRINGBONE_BRICKS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.REACHING_LANTERN, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.REACHING_LANTERN)));

        createShelfBlock(EBBlocks.SPRUCE_BOOKSHELF, 1,
                Ingredient.of(Blocks.SPRUCE_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_BOOKSHELF)));

        createShelfBlock(EBBlocks.BIRCH_BOOKSHELF, 1,
                Ingredient.of(Blocks.BIRCH_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_BOOKSHELF)));

        createShelfBlock(EBBlocks.JUNGLE_BOOKSHELF, 1,
                Ingredient.of(Blocks.JUNGLE_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_BOOKSHELF)));

        createShelfBlock(EBBlocks.ACACIA_BOOKSHELF, 1,
                Ingredient.of(Blocks.ACACIA_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_BOOKSHELF)));

        createShelfBlock(EBBlocks.DARK_OAK_BOOKSHELF, 1,
                Ingredient.of(Blocks.DARK_OAK_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_BOOKSHELF)));

        createShelfBlock(EBBlocks.MANGROVE_BOOKSHELF, 1,
                Ingredient.of(Blocks.MANGROVE_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_BOOKSHELF)));

        createShelfBlock(EBBlocks.CHERRY_BOOKSHELF, 1,
                Ingredient.of(Blocks.CHERRY_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_BOOKSHELF)));

        createShelfBlock(EBBlocks.BAMBOO_BOOKSHELF, 1,
                Ingredient.of(Blocks.BAMBOO_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_BOOKSHELF)));

        createShelfBlock(EBBlocks.CRIMSON_BOOKSHELF, 1,
                Ingredient.of(Blocks.CRIMSON_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_BOOKSHELF)));

        createShelfBlock(EBBlocks.WARPED_BOOKSHELF, 1,
                Ingredient.of(Blocks.WARPED_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_BOOKSHELF)));

        createShelfBlock(EBBlocks.ANCIENT_BOOKSHELF, 1,
                Ingredient.of(EBBlocks.ANCIENT_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_BOOKSHELF)));

        createShelfBlock(EBBlocks.GLOOM_BOOKSHELF, 1,
                Ingredient.of(EBBlocks.GLOOM_PLANKS), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_BOOKSHELF)));
        ...
        createTwoByTwoCheckersMealRecipe(EBBlocks.BRIMSTONE, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE)));
        ...
        stairBuilder(EBBlocks.BRIMSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_SLAB,
                Ingredient.of(EBBlocks.BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE), has(EBBlocks.BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE), has(EBBlocks.BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_VERTICAL_STAIRS)));

        createPaneRecipe(EBBlocks.BRIMSTONE_WALL, 6,
                Ingredient.of(EBBlocks.BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE), has(EBBlocks.BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_WALL)));
        ...
        createTwoByTwoRecipe(EBBlocks.POLISHED_BRIMSTONE, 4,
                Ingredient.of(EBBlocks.BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE), has(EBBlocks.BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BRIMSTONE)));
        ...
        stairBuilder(EBBlocks.POLISHED_BRIMSTONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BRIMSTONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_BRIMSTONE_SLAB,
                Ingredient.of(EBBlocks.POLISHED_BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE), has(EBBlocks.POLISHED_BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BRIMSTONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_BRIMSTONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE), has(EBBlocks.POLISHED_BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_BRIMSTONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.BRIMSTONE_BRICKS, 4,
                Ingredient.of(EBBlocks.POLISHED_BRIMSTONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE), has(EBBlocks.POLISHED_BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.BRIMSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.BRIMSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE_BRICKS), has(EBBlocks.BRIMSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.BRIMSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE_BRICKS), has(EBBlocks.BRIMSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.BRIMSTONE_TILES, 4,
                Ingredient.of(EBBlocks.BRIMSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE_BRICKS), has(EBBlocks.BRIMSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_TILES)));
        ...
        stairBuilder(EBBlocks.BRIMSTONE_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_TILE_SLAB,
                Ingredient.of(EBBlocks.BRIMSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE_TILES), has(EBBlocks.BRIMSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.BRIMSTONE_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.BRIMSTONE_TILES))
                .unlockedBy(getHasName(EBBlocks.BRIMSTONE_TILES), has(EBBlocks.BRIMSTONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_TILE_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_PILLAR, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_PILLAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_LAMP, 4)
                ...
                .pattern("@#@")
                .unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE), has(EBBlocks.POLISHED_BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_LAMP)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BRIMSTONE_WINDOW, 4)
                ...
                .pattern("@#@")
                .unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE), has(EBBlocks.POLISHED_BRIMSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BRIMSTONE_WINDOW)));
        ...
        stairBuilder(EBBlocks.ASPHALT_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ASPHALT_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ASPHALT_SLAB,
                Ingredient.of(EBBlocks.ASPHALT))
                .unlockedBy(getHasName(EBBlocks.ASPHALT), has(EBBlocks.ASPHALT))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ASPHALT_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ASPHALT_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ASPHALT))
                .unlockedBy(getHasName(EBBlocks.ASPHALT), has(EBBlocks.ASPHALT))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ASPHALT_VERTICAL_STAIRS)));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.RED_DYE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(Items.RED_DYE) + "_from_rose"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.CYAN_DYE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(Items.CYAN_DYE) + "_from_cyan_rose"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.WHITE_DYE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(Items.WHITE_DYE) + "_from_white_rose"));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_STONE_BRICKS, 4,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.SMOOTH_STONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.SMOOTH_STONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_BRICKS), has(EBBlocks.SMOOTH_STONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_STONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SMOOTH_STONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_BRICKS), has(EBBlocks.SMOOTH_STONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_BRICK_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.SMOOTH_STONE_TILES, 4,
                Ingredient.of(EBBlocks.SMOOTH_STONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_BRICKS), has(EBBlocks.SMOOTH_STONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_TILES)));
        ...
        stairBuilder(EBBlocks.SMOOTH_STONE_TILE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_TILE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_TILE_SLAB,
                Ingredient.of(EBBlocks.SMOOTH_STONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_TILES), has(EBBlocks.SMOOTH_STONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_TILE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.SMOOTH_STONE_TILE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.SMOOTH_STONE_TILES))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_TILES), has(EBBlocks.SMOOTH_STONE_TILES))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_TILE_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_STONE_PILLAR, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SMOOTH_STONE_PILLAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SMOOTH_STONE_BRICKS, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHISELED_SMOOTH_STONE_BRICKS)));

        createTwoByTwoCheckersMealRecipe(EBBlocks.POLISHED_STONE, 4,
                Ingredient.of(Blocks.STONE), Ingredient.of(Blocks.SMOOTH_STONE))
                .unlockedBy(getHasName(Blocks.STONE), has(Blocks.STONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_STONE)));
        ...
        stairBuilder(EBBlocks.POLISHED_STONE_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_STONE_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_STONE_SLAB,
                Ingredient.of(EBBlocks.POLISHED_STONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_STONE), has(EBBlocks.POLISHED_STONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_STONE_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_STONE_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_STONE))
                .unlockedBy(getHasName(EBBlocks.POLISHED_STONE), has(EBBlocks.POLISHED_STONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_STONE_VERTICAL_STAIRS)));
        ...
        createTwoByTwoRecipe(EBBlocks.REDSTONE_BRICKS, 1,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.REDSTONE_BRICKS)));
        ...
        stairBuilder(EBBlocks.REDSTONE_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.REDSTONE_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.REDSTONE_BRICK_SLAB,
                Ingredient.of(EBBlocks.REDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.REDSTONE_BRICKS), has(EBBlocks.REDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.REDSTONE_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.REDSTONE_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.REDSTONE_BRICKS))
                .unlockedBy(getHasName(EBBlocks.REDSTONE_BRICKS), has(EBBlocks.REDSTONE_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.REDSTONE_BRICK_VERTICAL_STAIRS)));
        ...
        createShelfBlock(EBBlocks.OAK_DECORATIVE_SHELF, 1,
                ...
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.OAK_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.SPRUCE_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.SPRUCE_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SPRUCE_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.BIRCH_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.BIRCH_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BIRCH_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.JUNGLE_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.JUNGLE_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.JUNGLE_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.ACACIA_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.ACACIA_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ACACIA_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.DARK_OAK_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.DARK_OAK_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.DARK_OAK_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.MANGROVE_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.MANGROVE_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MANGROVE_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.CHERRY_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.CHERRY_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CHERRY_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.BAMBOO_DECORATIVE_SHELF, 1,
                Ingredient.of(Blocks.BAMBOO_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.BAMBOO_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.CRIMSON_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.CRIMSON_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.CRIMSON_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.WARPED_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.WARPED_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WARPED_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.ANCIENT_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.ANCIENT_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ANCIENT_DECORATIVE_SHELF)));

        createShelfBlock(EBBlocks.GLOOM_DECORATIVE_SHELF, 1,
                Ingredient.of(EBBlocks.GLOOM_MOSAIC), Ingredient.of(Items.BOOK))
                .unlockedBy(getHasName(Items.BOOK), has(Items.BOOK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.GLOOM_DECORATIVE_SHELF)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.WEEPING_CANDLE, 1)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.WEEPING_CANDLE)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.TWISTING_CANDLE, 1)
                ...
                .pattern("#")
                .unlockedBy(getHasName(Items.HONEYCOMB), has(Items.HONEYCOMB))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.TWISTING_CANDLE)));
        ...
        stairBuilder(EBBlocks.ALMENTRA_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ALMENTRA_SLAB,
                Ingredient.of(EBBlocks.ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.ALMENTRA), has(EBBlocks.ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ALMENTRA_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.ALMENTRA), has(EBBlocks.ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_VERTICAL_STAIRS)));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.POLISHED_ALMENTRA,
                Ingredient.of(EBBlocks.ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.ALMENTRA), has(EBBlocks.ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_ALMENTRA)));
        ...
        stairBuilder(EBBlocks.POLISHED_ALMENTRA_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_ALMENTRA_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_ALMENTRA_SLAB,
                Ingredient.of(EBBlocks.POLISHED_ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.POLISHED_ALMENTRA), has(EBBlocks.POLISHED_ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_ALMENTRA_SLAB)));

        createVerticalStairsRecipe(EBBlocks.POLISHED_ALMENTRA_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.POLISHED_ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.POLISHED_ALMENTRA), has(EBBlocks.POLISHED_ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.POLISHED_ALMENTRA_VERTICAL_STAIRS)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createFourForFourWendysMealRecipe(EBBlocks.getDyedPolishedAlmentra(colors.getId()),
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedPolishedAlmentra(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            stairBuilder(EBBlocks.getDyedPolishedAlmentraStairs(colors.getId()),
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedPolishedAlmentraStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedPolishedAlmentraSlab(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedPolishedAlmentra(colors.getId())), has(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedPolishedAlmentraSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedPolishedAlmentraVerticalStairs(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedPolishedAlmentra(colors.getId())), has(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedPolishedAlmentraVerticalStairs(colors.getId()))));
        }

        createFourForFourWendysMealRecipe(EBBlocks.ALMENTRA_BRICKS,
                Ingredient.of(EBBlocks.POLISHED_ALMENTRA))
                .unlockedBy(getHasName(EBBlocks.POLISHED_ALMENTRA), has(EBBlocks.POLISHED_ALMENTRA))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_BRICKS)));
        ...
        stairBuilder(EBBlocks.ALMENTRA_BRICK_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_BRICK_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ALMENTRA_BRICK_SLAB,
                Ingredient.of(EBBlocks.ALMENTRA_BRICKS))
                .unlockedBy(getHasName(EBBlocks.ALMENTRA_BRICKS), has(EBBlocks.ALMENTRA_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_BRICK_SLAB)));

        createVerticalStairsRecipe(EBBlocks.ALMENTRA_BRICK_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.ALMENTRA_BRICKS))
                .unlockedBy(getHasName(EBBlocks.ALMENTRA_BRICKS), has(EBBlocks.ALMENTRA_BRICKS))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.ALMENTRA_BRICK_VERTICAL_STAIRS)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            createFourForFourWendysMealRecipe(EBBlocks.getDyedAlmentraBricks(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedPolishedAlmentra(colors.getId())), has(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraBricks(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            stairBuilder(EBBlocks.getDyedAlmentraBrickStairs(colors.getId()),
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraBrickStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedAlmentraBrickSlab(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentraBricks(colors.getId())), has(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraBrickSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedAlmentraBrickVerticalStairs(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentraBricks(colors.getId())), has(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraBrickVerticalStairs(colors.getId()))));
        }

        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.ALMENTRA_STATUE, EBBlocks.POLISHED_ALMENTRA, 1);

        for (DyeColor colors : DyeColor.values()) {
            stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedAlmentraStatues(colors.getId()), EBBlocks.getDyedPolishedAlmentra(colors.getId()), 1);
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            ...
            .unlockedBy(getHasName(EBBlocks.getDyedTerracottaTiles(colors.getId())), has(EBBlocks.getDyedTerracottaTiles(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedTerracottaTiles(colors.getId())) + "_from_base"));
        }

        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedAlmentra(colors.getId()), EBBlocks.ALMENTRA, DyeItem.byColor(colors).getDyeColor())
            .unlockedBy(getHasName(EBBlocks.getDyedAlmentra(colors.getId())), has(EBBlocks.getDyedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentra(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedPolishedAlmentra(colors.getId()), EBBlocks.POLISHED_ALMENTRA, DyeItem.byColor(colors).getDyeColor())
                    .unlockedBy(getHasName(EBBlocks.getDyedPolishedAlmentra(colors.getId())), has(EBBlocks.getDyedPolishedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedPolishedAlmentra(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingRecipe(EBBlocks.getDyedAlmentraBricks(colors.getId()), EBBlocks.ALMENTRA_BRICKS, DyeItem.byColor(colors).getDyeColor())
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentraBricks(colors.getId())), has(EBBlocks.getDyedAlmentraBricks(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraBricks(colors.getId())) + "_from_base"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingTagRecipe(EBBlocks.getDyedKnittedWools(colors.getId()), EBTags.Items.KNITTED_WOOL, DyeItem.byColor(colors).getDyeColor())
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(colors.getId())) + "_from_any"));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createBlockEightDyingTagRecipe(EBBlocks.getDyedKnittedCarpets(colors.getId()), EBTags.Items.KNITTED_CARPET, DyeItem.byColor(colors).getDyeColor())
                    ...
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedCarpets(colors.getId())) + "_from_any"));
        }
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.WHITE.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.WHITE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BLACK.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BLACK.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.PINK.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.PINK.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.MAGENTA.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.MAGENTA.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.PURPLE.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.PURPLE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BLUE.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BLUE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_BLUE.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_BLUE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.CYAN.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.CYAN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.GREEN.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.GREEN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIME.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIME.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.YELLOW.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.YELLOW.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.ORANGE.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.ORANGE.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.RED.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.RED.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.BROWN.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.BROWN.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.GRAY.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.GRAY.getId()))));
        ...
        createFourForFourWendysMealRecipe(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_GRAY.getId()),
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedKnittedWools(DyeColor.LIGHT_GRAY.getId()))));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, EBBlocks.MOSS_PASTE, 4)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.MOSS_PASTE)));
...
//                .offerTo(exporter, Identifier.of(ExcessiveBuilding.MOD_ID, getRecipeName(EBBlocks.TRAPPED_GLOOM_CHEST))));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.POLISHED_SANDSTONE), has(EBBlocks.POLISHED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SANDSTONE_PILLAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.POLISHED_RED_SANDSTONE), has(EBBlocks.POLISHED_RED_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.RED_SANDSTONE_PILLAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SOUL_SANDSTONE_PILLAR, 2)
                ...
                .pattern("#")
                .unlockedBy(getHasName(EBBlocks.POLISHED_SOUL_SANDSTONE), has(EBBlocks.POLISHED_SOUL_SANDSTONE))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.SOUL_SANDSTONE_PILLAR)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PAPER_BLOCK, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.PAPER_BLOCK)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_PAPER_BLOCK, 5)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_PAPER_BLOCK)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_PAPER_BLOCK, 5)
                .define('#', ItemTags.PLANKS).define('@', EBBlocks.PAPER_BLOCK)
                .pattern("#@#")
                .pattern("@@@")
                .pattern("#@#")
                .unlockedBy(getHasName(EBBlocks.PAPER_BLOCK), has(EBBlocks.PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_PAPER_BLOCK)));
        ...
        stairBuilder(EBBlocks.THIN_PAPER_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_PAPER_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_PAPER_SLAB,
                Ingredient.of(EBBlocks.THIN_PAPER_BLOCK))
                .unlockedBy(getHasName(EBBlocks.THIN_PAPER_BLOCK), has(EBBlocks.THIN_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_PAPER_SLAB)));

        createVerticalStairsRecipe(EBBlocks.THIN_PAPER_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.THIN_PAPER_BLOCK))
                .unlockedBy(getHasName(EBBlocks.THIN_PAPER_BLOCK), has(EBBlocks.THIN_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_PAPER_VERTICAL_STAIRS)));
        ...
        stairBuilder(EBBlocks.THICK_PAPER_STAIRS,
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_PAPER_STAIRS)));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_PAPER_SLAB,
                Ingredient.of(EBBlocks.THICK_PAPER_BLOCK))
                .unlockedBy(getHasName(EBBlocks.THICK_PAPER_BLOCK), has(EBBlocks.THICK_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_PAPER_SLAB)));

        createVerticalStairsRecipe(EBBlocks.THICK_PAPER_VERTICAL_STAIRS,
                Ingredient.of(EBBlocks.THICK_PAPER_BLOCK))
                .unlockedBy(getHasName(EBBlocks.THICK_PAPER_BLOCK), has(EBBlocks.THICK_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_PAPER_VERTICAL_STAIRS)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_DIAGONAL_PAPER_BLOCK, 6)
                ...
                .pattern("#@@")
                .unlockedBy(getHasName(EBBlocks.THIN_PAPER_BLOCK), has(EBBlocks.THIN_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_DIAGONAL_PAPER_BLOCK)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THIN_DIVIDED_PAPER_BLOCK, 6)
                ...
                .pattern("@#@")
                .unlockedBy(getHasName(EBBlocks.THIN_PAPER_BLOCK), has(EBBlocks.THIN_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THIN_DIVIDED_PAPER_BLOCK)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_DIAGONAL_PAPER_BLOCK, 6)
                .define('#', ItemTags.PLANKS).define('@', EBBlocks.THICK_PAPER_BLOCK)
                .pattern("@@#")
                .pattern("@#@")
                .pattern("#@@")
                .unlockedBy(getHasName(EBBlocks.THICK_PAPER_BLOCK), has(EBBlocks.THICK_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_DIAGONAL_PAPER_BLOCK)));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.THICK_DIVIDED_PAPER_BLOCK, 6)
                .define('#', ItemTags.PLANKS).define('@', EBBlocks.THICK_PAPER_BLOCK)
                .pattern("@#@")
                .pattern("@#@")
                .pattern("@#@")
                .unlockedBy(getHasName(EBBlocks.THICK_PAPER_BLOCK), has(EBBlocks.THICK_PAPER_BLOCK))
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.THICK_DIVIDED_PAPER_BLOCK)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.AMETHYST_LAMP, 2)
                ...
                .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.AMETHYST_LAMP)));
        ...
        for (DyeColor colors : DyeColor.values()) {
            stairBuilder(EBBlocks.getDyedAlmentraStairs(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentra(colors.getId())), has(EBBlocks.getDyedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraStairs(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.getDyedAlmentraSlab(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentra(colors.getId())), has(EBBlocks.getDyedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraSlab(colors.getId()))));
        }
        ...
        for (DyeColor colors : DyeColor.values()) {
            createVerticalStairsRecipe(EBBlocks.getDyedAlmentraVerticalStairs(colors.getId()),
                    Ingredient.of(EBBlocks.getDyedAlmentra(colors.getId())))
                    .unlockedBy(getHasName(EBBlocks.getDyedAlmentra(colors.getId())), has(EBBlocks.getDyedAlmentra(colors.getId())))
                    .save(exporter, ResourceLocation.tryBuild(ExcessiveBuilding.MOD_ID, getSimpleRecipeName(EBBlocks.getDyedAlmentraVerticalStairs(colors.getId()))));
        }
    }
